...
import static org.codelibs.sai.internal.tools.saigen.ScriptClassInfo.SCRIPT_CLASS_ANNO_DESC;
import static org.codelibs.sai.internal.tools.saigen.ScriptClassInfo.WHERE_ENUM_DESC;
...
public class ScriptClassInfoCollector extends ClassVisitor {
    ...
    public AnnotationVisitor visitAnnotation(final String desc, final boolean visible) {
        ...
        if (SCRIPT_CLASS_ANNO_DESC.equals(desc)) {
            return new AnnotationVisitor(Opcodes.ASM7, delegateAV) {
                @Override
            ...
            public AnnotationVisitor visitAnnotation(final String descriptor, final boolean visible) {
                ...
                if (annoKind != null) {
                    if ((methodAccess & Opcodes.ACC_STATIC) == 0) {
                        error(methodName, methodDesc, "saigen method annotations cannot be on instance methods");
                    }
