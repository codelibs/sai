...
/**
 * Tests for javax.script.Invocable implementation of sai.
 */
...
public class InvocableTest {
    ...
    public void invokeMethodMixEnginesTest() {
        final ScriptEngineManager m = new ScriptEngineManager();
        final ScriptEngine engine1 = m.getEngineByName("sai");
        final ScriptEngine engine2 = m.getEngineByName("sai");
    ...
    public void variableArityInterfaceTest() throws ScriptException {
        final ScriptEngineManager m = new ScriptEngineManager();
        final ScriptEngine e = m.getEngineByName("sai");
        e.eval("function test1(i, strings) {"
        ...
        Assert.assertEquals(itf.test2(44, "c", "d", "e"),
                "arguments[0] == 44, arguments[1] instanceof java.lang.String[] == true, arguments[1] == [c, d, e]");
    }
