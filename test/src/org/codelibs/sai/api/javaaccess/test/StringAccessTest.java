...
/**
 * @test
 * @build org.codelibs.sai.api.javaaccess.test.SharedObject org.codelibs.sai.api.javaaccess.test.Person org.codelibs.sai.api.javaaccess.test.StringAccessTest
 * @run testng/othervm org.codelibs.sai.api.javaaccess.test.StringAccessTest
 */
...
public class StringAccessTest {
    ...
    public void accessFieldStringArray() throws ScriptException {
        ...
        e.eval("var t_string_arr = new (Java.type(\"java.lang.String[]\"))(3);" + "t_string_arr[0] = 'abc';" + "t_string_arr[1] = '123';"
                + "t_string_arr[2] = 'xyzzzz';" + "o.publicStringArray = t_string_arr;");
        assertArrayEquals(new String[] { "abc", "123", "xyzzzz" }, o.publicStringArray);
        e.eval("o.publicStringArray[0] = 'sai';");
        assertEquals("sai", o.publicStringArray[0]);
    }
    ...
    public void accessStaticFieldStringArray() throws ScriptException {
        ...
        e.eval("var ts_string_arr = new (Java.type(\"java.lang.String[]\"))(3);" + "ts_string_arr[0] = 'abc';"
                + "ts_string_arr[1] = '123';" + "ts_string_arr[2] = 'xyzzzz';" + "SharedObject.publicStaticStringArray = ts_string_arr;");
        assertArrayEquals(new String[] { "abc", "123", "xyzzzz" }, SharedObject.publicStaticStringArray);
        e.eval("SharedObject.publicStaticStringArray[0] = 'sai';");
        assertEquals("sai", SharedObject.publicStaticStringArray[0]);
    }
    ...
    public void accessFinalFieldStringArray() throws ScriptException {
        ...
        e.eval("var tf_string_arr = new (Java.type(\"java.lang.String[]\"))(3);" + "tf_string_arr[0] = 'abc';"
                + "tf_string_arr[1] = '123';" + "tf_string_arr[2] = 'xyzzzz';" + "o.publicFinalStringArray = tf_string_arr;");
        assertArrayEquals(new String[] { "FinalArrayString[0]", "FinalArrayString[1]", "FinalArrayString[2]", "FinalArrayString[3]" },
                o.publicFinalStringArray);
        e.eval("o.publicFinalStringArray[0] = 'sai';");
        assertEquals("sai", o.publicFinalStringArray[0]);
    }
    ...
    public void accessStaticFinalFieldStringArray() throws ScriptException {
        ...
        e.eval("var tsf_string_arr = new (Java.type(\"java.lang.String[]\"))(3);" + "tsf_string_arr[0] = 'abc';"
                + "tsf_string_arr[1] = '123';" + "tsf_string_arr[2] = 'xyzzzz';"
                + "SharedObject.publicStaticFinalStringArray = tsf_string_arr;");
        assertArrayEquals(new String[] { "StaticFinalArrayString[0]", "StaticFinalArrayString[1]", "StaticFinalArrayString[2]",
                "StaticFinalArrayString[3]" }, SharedObject.publicStaticFinalStringArray);
        e.eval("SharedObject.publicStaticFinalStringArray[0] = 'sai';");
        assertEquals("sai", SharedObject.publicStaticFinalStringArray[0]);
    }
