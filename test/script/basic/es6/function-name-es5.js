...
/**
 * The ES2015 function "name" rules are gated on --language=es6. This runs the
 * same probes as function-name.js at the default language level, where an
 * anonymous function is still called "" and bind does not rename anything.
 *
 * @test
 * @run
 */
