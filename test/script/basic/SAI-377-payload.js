...
/*
 * SAI-377: Typed arrays. Payload for litte and big endian platforms.
 *
 * @subtest
 * @run
 */
...
(function() {
  ...
  // v8 and sai disagree on out-of-bounds uint32 indices: v8 won't go to the prototype.
  z[0xf0000000] = "asdf"; print(z[0xf0000000]);
  z[0xffffffff] = "asdf"; print(z[0xffffffff]);
  z[0x70000000] = "asdf"; print(z[0x70000000]);

  // this will work in firefox and sai (not in v8).
