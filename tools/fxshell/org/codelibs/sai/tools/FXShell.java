...
/**
 * This shell is designed to launch a JavaFX application written in Sai JavaScript.
 */
public class FXShell extends Application {
    ...
    /**
     * Sai script engine factory.
     */
    private SaiScriptEngineFactory factory;
    /**
     * Main instance of Sai script engine.
     */
    ...
    public void init() throws Exception {
        ...
        // Locate the Sai script engine factory.  Needed for passing arguments.
        for (ScriptEngineFactory engineFactory : this.manager.getEngineFactories()) {
             if (engineFactory.getEngineName().equals("Oracle Sai") && engineFactory instanceof SaiScriptEngineFactory) {
                this.factory = (SaiScriptEngineFactory)engineFactory;
            }
        }

        // If none located.
        if (this.factory == null) {
            System.err.println("Sai script engine not available");
            System.exit(1);
        }
        ...
        // Create a Sai script engine with specified arguments.
