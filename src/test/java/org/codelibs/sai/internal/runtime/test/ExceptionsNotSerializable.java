 ...
 *
 * @test
 * @run testng org.codelibs.sai.internal.runtime.test.ExceptionsNotSerializable
 */
@SuppressWarnings("javadoc")
public class ExceptionsNotSerializable {
    @Test
    public void rewriteExceptionNotSerializable() throws ScriptException {
        // NOTE: we must create a RewriteException in a context of a Sai engine, as it uses Global.newIntance()
        // internally.
        final ScriptEngine e = new SaiScriptEngineFactory().getScriptEngine();
