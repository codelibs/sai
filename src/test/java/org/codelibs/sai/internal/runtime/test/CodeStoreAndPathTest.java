 ...
 * @run testng org.codelibs.sai.internal.runtime.test.CodeStoreAndPathTest
 */
@SuppressWarnings("javadoc")
public class CodeStoreAndPathTest {

    final String code1 = "var code1; var x = 'Hello Script'; var x1 = 'Hello Script'; "
            + "var x2 = 'Hello Script'; var x3 = 'Hello Script'; " + "var x4 = 'Hello Script'; var x5 = 'Hello Script';"
            + "var x6 = 'Hello Script'; var x7 = 'Hello Script'; " + "var x8 = 'Hello Script'; var x9 = 'Hello Script'; "
            + "var x10 = 'Hello Script';" + "function f() {x ='Bye Script'; x1 ='Bye Script'; x2='Bye Script';"
            + "x3='Bye Script'; x4='Bye Script'; x5='Bye Script'; x6='Bye Script';"
            + "x7='Bye Script'; x8='Bye Script'; var x9 = 'Hello Script'; " + "var x10 = 'Hello Script';}"
    ...
    final String codeCache = "build/sai_code_cache";
    ...
    public void pathHandlingTest() {
        ...
        final Path actualCodeCachePath =
                FileSystems.getDefault().getPath(System.getProperty("sai.persistent.code.cache")).toAbsolutePath();
        // Check that sai code cache is created in current working directory
