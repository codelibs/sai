 ...
 * @run testng/othervm org.codelibs.sai.internal.runtime.test.NoPersistenceCachingTest
 */
...
public class NoPersistenceCachingTest {
    ...
    public void setupTest() {
        ...
        engine = saiFactory.getScriptEngine(options);
    ...
    public void runTest(final int numberOfContext, final String expectedOutputPattern, final int expectedPatternOccurrence) {
        ...
        if (matches != expectedPatternOccurrence) {
            fail("Number of cache hit is not correct, expected: " + expectedPatternOccurrence + " and found: " + matches + "\n" + stderr);
        }
        stderr.reset();
    }
