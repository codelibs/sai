...
/**
 * Tests to check org.codelibs.sai.api.scripting.ScriptObjectMirror API.
 */
...
public class ScriptObjectMirrorTest {
    ...
    public void reflectionTest() throws ScriptException {
        ...
        assertTrue(map.values().contains("sai"));
        assertTrue(map.containsValue("sai"));
    ...
    public void mirrorNewObjectGlobalFunctionTest() throws ScriptException {
        final ScriptEngineManager m = new ScriptEngineManager();
        final ScriptEngine e = m.getEngineByName("sai");
        final ScriptEngine e2 = m.getEngineByName("sai");
    ...
    public void conversionTest() throws ScriptException {
        ...
        ScriptObjectMirror obj = (ScriptObjectMirror) e.eval("({ valueOf: function() { return 42 } })");
        assertEquals(Double.valueOf(42.0), obj.to(Double.class));

        obj = (ScriptObjectMirror) e.eval("({ toString: function() { return 'foo' } })");
    ...
    public void checkMirrorToObject() throws Exception {
        ...
        final ScriptEngine engine = engineManager.getEngineByName("sai");
    ...
    public void mirrorUnwrapInterfaceMethod() throws Exception {
        ...
        final ScriptEngine engine = engineManager.getEngineByName("sai");
        final Invocable invocable = (Invocable) engine;
        engine.eval("function apply(obj) { " + " return obj instanceof Packages.org.codelibs.sai.api.scripting.ScriptObjectMirror; " + "}");
        @SuppressWarnings("unchecked")
    ...
    public void checkThisForJSObjectEval() throws Exception {
        final ScriptEngineManager engineManager = new ScriptEngineManager();
        final ScriptEngine e = engineManager.getEngineByName("sai");
