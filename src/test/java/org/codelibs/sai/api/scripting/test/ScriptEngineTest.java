...
package org.codelibs.sai.api.scripting.test;
...
/**
 * Tests for JSR-223 script engine for Sai.
 *
 * @test
 * @build org.codelibs.sai.api.scripting.test.Window org.codelibs.sai.api.scripting.test.WindowEventHandler org.codelibs.sai.api.scripting.test.VariableArityTestInterface org.codelibs.sai.api.scripting.test.ScriptEngineTest
 * @run testng/othervm org.codelibs.sai.api.scripting.test.ScriptEngineTest
 */
...
public class ScriptEngineTest {
    ...
    public void argumentsTest() {
        ...
        final ScriptEngine e = m.getEngineByName("sai");
    ...
    public void argumentsWithTest() {
        ...
        try {
            e.put("arguments", args);
            final Object arg0 = e.eval("var imports = new JavaImporter(java.io); " + " with(imports) { arguments[0] }");
            final Object arg1 = e.eval("var imports = new JavaImporter(java.util, java.io); " + " with(imports) { arguments[1] }");
            assertEquals(args[0], arg0);
            assertEquals(args[1], arg1);
        } catch (final Exception exp) {
            exp.printStackTrace();
    ...
    public void factoryTests() {
        ...
        boolean seenSai = false, seenJavaScript = false, seenECMAScript = false;
    ...
    public void scriptObjectAutoConversionTest() throws ScriptException {
        ...
        e.put("Window", e.eval("Packages.org.codelibs.sai.api.scripting.test.Window"));
    ...
    public void checkProxyAccess() throws ScriptException {
        ...
        final Runnable r =
                (Runnable) Proxy.newProxyInstance(ScriptEngineTest.class.getClassLoader(), new Class[] { Runnable.class },
    ...
    private static String[] propNames = { "java.version", "java.vendor", "java.vendor.url", "java.class.version", "os.name", "os.version",
            "os.arch", "file.separator", "path.separator", "line.separator", "java.specification.version", "java.specification.vendor",
            "java.specification.name", "java.vm.specification.version", "java.vm.specification.vendor", "java.vm.specification.name",
    ...
    // @bug 8054223: Sai: AssertionError when use __DIR__ and ScriptEngine.eval()
    @Test
    ...
    // with sai engine's ENGINE_SCOPE bindings
    @Test
    public void enumerableGlobalsTest() throws ScriptException {
        ...
        final Object enumerable = e.eval("Object.getOwnPropertyDescriptor(this, " + " 'javax.script.filename').enumerable");
    ...
    // @bug 8050977: Java8 Javascript Sai exception:
    // no current Global instance for sai
    @Test
    public void currentGlobalMissingTest() throws Exception {
        final ScriptEngineManager manager = new ScriptEngineManager();
        final ScriptEngine e = manager.getEngineByName("sai");
    ...
    // @bug 8068524: SaiScriptEngineFactory.getParameter() throws IAE
    ...
    public void testLengthOnArrayLikeObjects() throws Exception {
        final ScriptEngine e = new ScriptEngineManager().getEngineByName("sai");
    ...
    // @bug JDK-8068603: SaiScriptEngine.put/get() impls don't conform to NPE, IAE spec assertions
    @Test
    ...
    // @bug 8071989: SaiScriptEngine returns javax.script.ScriptContext instance
    ...
    private static void checkProperty(final ScriptEngine e, final String name) throws ScriptException {
