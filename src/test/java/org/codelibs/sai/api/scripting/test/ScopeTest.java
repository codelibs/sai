...
public class ScopeTest {
    ...
    public void engineScopeTest() {
        ...
        assertEquals(engineScope.get("myVar"), "sai");
        assertEquals(e.get("myVar"), "sai");
    }
    ...
    public static void testMegamorphicGetInGlobal() throws Exception {
        final ScriptEngineManager m = new ScriptEngineManager();
        final ScriptEngine engine = m.getEngineByName("sai");
    ...
    private static class ScriptRunner implements Runnable {
        ...
        ScriptRunner(final ScriptEngine engine, final ScriptContext context, final String source, final Object expected,
                final int iterations) {
            this.engine = engine;
    ...
    // @bug 8071678: SaiScriptEngine returns javax.script.ScriptContext instance
    ...
    public void testGlobalScopeSearch() throws Exception {
        ...
        assertEquals(c.getAttributesScope("name1234"), ScriptContext.GLOBAL_SCOPE);
    }

    // @bug 8071594: SaiScriptEngine returns javax.script.ScriptContext instance
    ...
    public static class RecursiveEval {
        private final ScriptEngineFactory factory = new SaiScriptEngineFactory();
    ...
    public void megamorphicPropertyReadTest() throws ScriptException {
        ...
        // Why 16 is the upper limit of this loop? The default sai dynalink megamorphic threshold is 16.
        // See org.codelibs.sai.internal.runtime.linker.Bootstrap.NASHORN_DEFAULT_UNSTABLE_RELINK_THRESHOLD
    ...
    public void invokeFunctionInGlobalScopeTest() throws Exception {
        final ScriptEngine engine = new ScriptEngineManager().getEngineByName("sai");
