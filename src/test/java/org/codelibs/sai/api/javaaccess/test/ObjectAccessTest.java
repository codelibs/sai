...
/**
 * @test
 * @build org.codelibs.sai.api.javaaccess.test.SharedObject org.codelibs.sai.api.javaaccess.test.Person org.codelibs.sai.api.javaaccess.test.ObjectAccessTest
 * @run testng/othervm org.codelibs.sai.api.javaaccess.test.ObjectAccessTest
 */
...
public class ObjectAccessTest {
    ...
    public void accessFieldObjectArray() throws ScriptException {
        ...
        e.eval("var t_object_arr = new (Java.type(\"org.codelibs.sai.api.javaaccess.test.Person[]\"))(3);"
                + "t_object_arr[0] = new Person(100);" + "t_object_arr[1] = new Person(120);" + "t_object_arr[2] = new Person(140);"
    ...
    public void accessStaticFieldObjectArray() throws ScriptException {
        ...
        e.eval("var ts_object_arr = new (Java.type(\"org.codelibs.sai.api.javaaccess.test.Person[]\"))(3);"
                + "ts_object_arr[0] = new Person(100);" + "ts_object_arr[1] = new Person(120);" + "ts_object_arr[2] = new Person(140);"
    ...
    public void accessFinalFieldObjectArray() throws ScriptException {
        ...
        e.eval("var tf_object_arr = new (Java.type(\"org.codelibs.sai.api.javaaccess.test.Person[]\"))(3);"
                + "tf_object_arr[0] = new Person(100);" + "tf_object_arr[1] = new Person(120);" + "tf_object_arr[2] = new Person(140);"
    ...
    public void accessStaticFinalFieldObjectArray() throws ScriptException {
        ...
        e.eval("var tsf_object_arr = new (Java.type(\"org.codelibs.sai.api.javaaccess.test.Person[]\"))(3);"
                + "tsf_object_arr[0] = new Person(100);" + "tsf_object_arr[1] = new Person(120);" + "tsf_object_arr[2] = new Person(140);"
                + "SharedObject.publicStaticFinalObjectArray = tsf_object_arr;");
        assertArrayEquals(new Person[] { new Person(-9), new Person(110), new Person(Integer.MAX_VALUE) },
                SharedObject.publicStaticFinalObjectArray);
