...
/**
 * @test
 * @build org.codelibs.sai.api.javaaccess.test.SharedObject org.codelibs.sai.api.javaaccess.test.Person org.codelibs.sai.api.javaaccess.test.BooleanAccessTest
 * @run testng/othervm org.codelibs.sai.api.javaaccess.test.BooleanAccessTest
 */
...
public class BooleanAccessTest {
    ...
    public void accessFieldBooleanArray() throws ScriptException {
        ...
        e.eval("var t_boolean_arr = new (Java.type(\"boolean[]\"))(3);" + "t_boolean_arr[0] = true;" + "t_boolean_arr[1] = false;"
                + "t_boolean_arr[2] = false;" + "o.publicBooleanArray = t_boolean_arr;");
    ...
    public void accessStaticFieldBooleanArray() throws ScriptException {
        ...
        e.eval("var ts_boolean_arr = new (Java.type(\"boolean[]\"))(3);" + "ts_boolean_arr[0] = true;" + "ts_boolean_arr[1] = false;"
                + "ts_boolean_arr[2] = true;" + "SharedObject.publicStaticBooleanArray = ts_boolean_arr;");
    ...
    public void accessFinalFieldBooleanArray() throws ScriptException {
        ...
        e.eval("var tf_boolean_arr = new (Java.type(\"boolean[]\"))(3);" + "tf_boolean_arr[0] = false;" + "tf_boolean_arr[1] = false;"
                + "tf_boolean_arr[2] = true;" + "o.publicOFinalbjectArray = tf_boolean_arr;");
    ...
    public void accessStaticFinalFieldBooleanArray() throws ScriptException {
        ...
        e.eval("var tsf_boolean_arr = new (Java.type(\"boolean[]\"))(3);" + "tsf_boolean_arr[0] = false;" + "tsf_boolean_arr[1] = true;"
                + "tsf_boolean_arr[2] = false;" + "SharedObject.publicStaticFinalBooleanArray = tsf_boolean_arr;");
