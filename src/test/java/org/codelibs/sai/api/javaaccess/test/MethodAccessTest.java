...
/**
 * @test
 * @build org.codelibs.sai.api.javaaccess.test.SharedObject org.codelibs.sai.api.javaaccess.test.Person org.codelibs.sai.api.javaaccess.test.MethodAccessTest
 * @run testng/othervm org.codelibs.sai.api.javaaccess.test.MethodAccessTest
 */
...
public class MethodAccessTest {
    ...
    public static void setUpClass() throws ScriptException {
        ...
        e.eval("var Person = Packages.org.codelibs.sai.api.javaaccess.test.Person;");
    }
    ...
    public void accessMethodthrowsCheckedException() throws ScriptException {
        e.eval("try {" + "    var a = java.lang.Long.parseLong('foo');" + "} catch(e) {" + "    var isThrown = true;"
                + "    var isNumberException = e instanceof java.lang.NumberFormatException;" + "} finally {"
    ...
    public void accessMethodthrowsUnCheckedException() throws ScriptException {
        e.eval("try {" + "    var a = java.lang.String.valueOf(null);" + "} catch(e) {" + "    var isThrown = true;"
                + "    var isNumberException = e instanceof java.lang.NullPointerException;" + "} finally {"
                + "    var isFinalized = true;" + "}");
    ...
    public void accessMethodBooleanArray() throws ScriptException {
        assertTrue(Arrays.equals(o.booleanArrayMethod(o.publicBooleanArray),
    ...
    public void accessDefaultConstructor() throws ScriptException {
        e.eval("var dc = new Packages.org.codelibs.sai.api.javaaccess.test.Person()");
        assertEquals(new Person(), e.get("dc"));
    }

    @Test
    public void accessCustomConstructor() throws ScriptException {
        e.eval("var cc = new Packages.org.codelibs.sai.api.javaaccess.test.Person(17)");
    ...
    public void accessMethod2ObjectParams() throws ScriptException {
        assertArrayEquals(new Person[] { new Person(200), new Person(300) },
                (Person[]) e.eval("o.twoObjectParamMethod(new Person(300),new Person(200));"));
    }

    @Test
    public void accessMethod3ObjectParams() throws ScriptException {
        assertArrayEquals(new Person[] { new Person(3), new Person(2), new Person(1) },
                (Person[]) e.eval("o.threeObjectParamMethod(new Person(1),new Person(2),new Person(3));"));
    }

    @Test
    public void accessMethod8ObjectParams() throws ScriptException {
        assertArrayEquals(new Person[] { new Person(8), new Person(7), new Person(6), new Person(5), new Person(4), new Person(3),
                new Person(2), new Person(1) }, (Person[]) e.eval("o.eightObjectParamMethod(new Person(1),new Person(2),new Person(3),"
                + "new Person(4),new Person(5),new Person(6),new Person(7),new Person(8));"));
    }

    @Test
    public void accessMethod9ObjectParams() throws ScriptException {
        assertArrayEquals(new Person[] { new Person(9), new Person(8), new Person(7), new Person(6), new Person(5), new Person(4),
                new Person(3), new Person(2), new Person(1) },
                (Person[]) e.eval("o.nineObjectParamMethod(new Person(1),new Person(2),new Person(3),"
                        + "new Person(4),new Person(5),new Person(6)," + "new Person(7),new Person(8),new Person(9));"));
    }
    ...
    public void accessMethodObjectEllipsis() throws ScriptException {
        assertArrayEquals(new Person[] { new Person(9), new Person(8), new Person(7), new Person(6), new Person(5), new Person(4),
                new Person(3), new Person(2), new Person(1) },
                (Person[]) e.eval("o.methodObjectEllipsis(new Person(1),new Person(2),new Person(3),"
                        + "new Person(4),new Person(5),new Person(6)," + "new Person(7),new Person(8),new Person(9));"));
    ...
    public void accessMethodPrimitiveEllipsis() throws ScriptException {
        assertArrayEquals(new Person[] { new Person(1), new Person(3), new Person(2) },
                (Person[]) e.eval("o.methodPrimitiveEllipsis(1,3,2);"));
        assertArrayEquals(new Person[] {}, (Person[]) e.eval("o.methodPrimitiveEllipsis();"));
        assertArrayEquals(o.methodPrimitiveEllipsis(9, 8, 7, 6, 5, 4, 3, 2, 1),
                (Person[]) e.eval("o.methodPrimitiveEllipsis(9,8,7,6,5,4,3,2,1);"));
    }

    @Test
    public void accessMethodMixedEllipsis() throws ScriptException {
        assertArrayEquals(new Object[] { new Person(1), 12, "hello", true },
                (Object[]) e.eval("o.methodMixedEllipsis(new Person(1),12,'hello',true);"));
    ...
    public void accessMethodMixedWithEllipsis() throws ScriptException {
        assertArrayEquals(new Object[] { "Hello", 10, true, -100500, 80d },
                (Object[]) e.eval("o.methodMixedWithEllipsis('Hello', 10, true, -100500,80.0);"));
        assertArrayEquals(new Object[] { "Sai", 15 }, (Object[]) e.eval("o.methodMixedWithEllipsis('Sai',15);"));
    }
