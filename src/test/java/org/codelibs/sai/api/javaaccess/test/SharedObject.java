...
public class SharedObject {
    ...
    public char[] publicCharArray = "Hello Sai".toCharArray();
    public Character publicCharBox = 'B';
    // Public static fields
    public static String publicStaticString = "PublicStaticString";
    public static String[] publicStaticStringArray = { "StaticArrayString[0]", "StaticArrayString[1]", "StaticArrayString[2]",
            "StaticArrayString[3]" };
    ...
    public static char[] publicStaticCharArray = "Sai".toCharArray();
    public static Character publicStaticCharBox = 'D';
    // Public final fields
    public final String publicFinalString = "PublicFinalString";
    public final String[] publicFinalStringArray = { "FinalArrayString[0]", "FinalArrayString[1]", "FinalArrayString[2]",
            "FinalArrayString[3]" };
    ...
    public final char[] publicFinalCharArray = "Sai hello".toCharArray();
    ...
    public static final String[] publicStaticFinalStringArray = { "StaticFinalArrayString[0]", "StaticFinalArrayString[1]",
            "StaticFinalArrayString[2]", "StaticFinalArrayString[3]" };
    ...
    public Person[] eightObjectParamMethod(final Person arg1, final Person arg2, final Person arg3, final Person arg4, final Person arg5,
            final Person arg6, final Person arg7, final Person arg8) {
        return new Person[] { arg8, arg7, arg6, arg5, arg4, arg3, arg2, arg1 };
    }

    public Person[] nineObjectParamMethod(final Person arg1, final Person arg2, final Person arg3, final Person arg4, final Person arg5,
            final Person arg6, final Person arg7, final Person arg8, final Person arg9) {
