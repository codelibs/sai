...
package org.codelibs.sai.api.javaaccess.test;
...
/**
 * @test
 * @build org.codelibs.sai.api.javaaccess.test.SharedObject org.codelibs.sai.api.javaaccess.test.Person org.codelibs.sai.api.javaaccess.test.NumberAccessTest
 * @run testng/othervm org.codelibs.sai.api.javaaccess.test.NumberAccessTest
 */
...
public class NumberAccessTest {
    ...
    public static void setUpClass() throws ScriptException {
        ...
        e = m.getEngineByName("sai");
        o = new SharedObject();
        e.put("o", o);
        e.eval("var SharedObject = Packages.org.codelibs.sai.api.javaaccess.test.SharedObject;");
    }
    ...
    public void accessFieldLongArray() throws ScriptException {
        ...
        e.eval("var t_long_arr = new (Java.type(\"long[]\"))(3);" + "t_long_arr[0] = -189009;" + "t_long_arr[1] = 456;"
                + "t_long_arr[2] = 600000001;" + "o.publicLongArray = t_long_arr;");
    ...
    public void accessStaticFieldLongArray() throws ScriptException {
        ...
        e.eval("var ts_long_arr = new (Java.type(\"long[]\"))(3);" + "ts_long_arr[0] = -189009;" + "ts_long_arr[1] = 456;"
                + "ts_long_arr[2] = 600000001;" + "SharedObject.publicStaticLongArray = ts_long_arr;");
        // e.eval("o.publicIntArray = [-189009,456,600000001];");
    ...
    public void accessFinalFieldLongArray() throws ScriptException {
        ...
        e.eval("var tf_long_arr = new (Java.type(\"long[]\"))(3);" + "tf_long_arr[0] = -189009;" + "tf_long_arr[1] = 456;"
                + "tf_long_arr[2] = 600000001;" + "o.publicFinalLongArray = tf_long_arr;");
        // e.eval("o.publicIntArray = [-189009,456,600000001];");
    ...
    public void accessStaticFinalFieldLongArray() throws ScriptException {
        ...
        e.eval("var tsf_long_arr = new (Java.type(\"long[]\"))(3);" + "tsf_long_arr[0] = -189009;" + "tsf_long_arr[1] = 456;"
                + "tsf_long_arr[2] = 600000001;" + "SharedObject.publicStaticFinalLongArray = tsf_long_arr;");
        // e.eval("o.publicIntArray = [-189009,456,600000001];");
    ...
    public void accessFieldIntArray() throws ScriptException {
        ...
        e.eval("var t_int_arr = new (Java.type(\"int[]\"))(3);" + "t_int_arr[0] = 4;" + "t_int_arr[1] = 5;" + "t_int_arr[2] = 6;"
    ...
    public void accessStaticFieldIntArray() throws ScriptException {
        ...
        e.eval("var ts_int_arr = new (Java.type(\"int[]\"))(3);" + "ts_int_arr[0] = 4;" + "ts_int_arr[1] = 5;" + "ts_int_arr[2] = 6;"
    ...
    public void accessFinalFieldIntArray() throws ScriptException {
        ...
        e.eval("var tf_int_arr = new (Java.type(\"int[]\"))(3);" + "tf_int_arr[0] = 4;" + "tf_int_arr[1] = 5;" + "tf_int_arr[2] = 6;"
    ...
    public void accessStaticFinalFieldIntArray() throws ScriptException {
        ...
        e.eval("var tsf_int_arr = new (Java.type(\"int[]\"))(3);" + "tsf_int_arr[0] = 4;" + "tsf_int_arr[1] = 5;" + "tsf_int_arr[2] = 6;"
    ...
    public void accessFieldByteArray() throws ScriptException {
        ...
        e.eval("var t_byte_arr = new (Java.type(\"byte[]\"))(3);" + "t_byte_arr[0] = -18;" + "t_byte_arr[1] = 56;" + "t_byte_arr[2] = 60;"
    ...
    public void accessStaticFieldByteArray() throws ScriptException {
        ...
        e.eval("var ts_byte_arr = new (Java.type(\"byte[]\"))(3);" + "ts_byte_arr[0] = -18;" + "ts_byte_arr[1] = 56;"
                + "ts_byte_arr[2] = 60;" + "SharedObject.publicStaticByteArray = ts_byte_arr;");
    ...
    public void accessFinalFieldByteArray() throws ScriptException {
        ...
        e.eval("var tf_byte_arr = new (Java.type(\"byte[]\"))(3);" + "tf_byte_arr[0] = -18;" + "tf_byte_arr[1] = 56;"
                + "tf_byte_arr[2] = 60;" + "o.publicFinalByteArray = tf_byte_arr;");
    ...
    public void accessStaticFinalFieldByteArray() throws ScriptException {
        ...
        e.eval("var tsf_byte_arr = new (Java.type(\"byte[]\"))(3);" + "tsf_byte_arr[0] = -18;" + "tsf_byte_arr[1] = 56;"
                + "tsf_byte_arr[2] = 60;" + "SharedObject.publicStaticFinalByteArray = tsf_byte_arr;");
    ...
    public void accessFieldShortArray() throws ScriptException {
        ...
        e.eval("var t_short_arr = new (Java.type(\"short[]\"))(3);" + "t_short_arr[0] = 90;" + "t_short_arr[1] = 5;"
                + "t_short_arr[2] = -6000;" + "o.publicShortArray = t_short_arr;");
    ...
    public void accessStaticFieldShortArray() throws ScriptException {
        ...
        e.eval("var ts_short_arr = new (Java.type(\"short[]\"))(3);" + "ts_short_arr[0] = 90;" + "ts_short_arr[1] = 5;"
                + "ts_short_arr[2] = -6000;" + "SharedObject.publicStaticShortArray = ts_short_arr;");
    ...
    public void accessFinalFieldShortArray() throws ScriptException {
        ...
        e.eval("var tf_short_arr = new (Java.type(\"short[]\"))(3);" + "tf_short_arr[0] = 90;" + "tf_short_arr[1] = 5;"
                + "tf_short_arr[2] = -6000;" + "o.publicFinalShortArray = tf_short_arr;");
    ...
    public void accessStaticFinalFieldShortArray() throws ScriptException {
        ...
        e.eval("var tsf_short_arr = new (Java.type(\"short[]\"))(3);" + "tsf_short_arr[0] = 90;" + "tsf_short_arr[1] = 5;"
                + "tsf_short_arr[2] = -6000;" + "SharedObject.publicStaticFinalShortArray = tsf_short_arr;");
    ...
    public void accessFieldCharArray() throws ScriptException {
        ...
        e.eval("var t_char_arr = new (Java.type(\"char[]\"))(3);" + "t_char_arr[0] = 'F';" + "t_char_arr[1] = 'o';"
                + "t_char_arr[2] = 'o';" + "o.publicCharArray = t_char_arr;");
    ...
    public void accessStaticFieldCharArray() throws ScriptException {
        ...
        e.eval("var ts_char_arr = new (Java.type(\"char[]\"))(3);" + "ts_char_arr[0] = 'G';" + "ts_char_arr[1] = 'o';"
                + "ts_char_arr[2] = 'o';" + "SharedObject.publicStaticCharArray = ts_char_arr;");
    ...
    public void accessFinalCharArray() throws ScriptException {
        ...
        e.eval("var tf_char_arr = new (Java.type(\"char[]\"))(3);" + "tf_char_arr[0] = 'F';" + "tf_char_arr[1] = 'o';"
                + "tf_char_arr[2] = 'o';" + "o.publicFinalCharArray = tf_char_arr;");
        assertArrayEquals("Sai hello".toCharArray(), o.publicFinalCharArray);
    ...
    public void accessStaticFinalFieldCharArray() throws ScriptException {
        ...
        e.eval("var tsf_char_arr = new (Java.type(\"char[]\"))(3);" + "tsf_char_arr[0] = 'Z';" + "tsf_char_arr[1] = 'o';"
                + "tsf_char_arr[2] = 'o';" + "SharedObject.publicStaticFinalCharArray = tsf_char_arr;");
    ...
    public void accessFieldFloatArray() throws ScriptException {
        ...
        e.eval("var t_float_arr = new (Java.type(\"float[]\"))(3);" + "t_float_arr[0] = 9.0;" + "t_float_arr[1] = 5.12345;"
                + "t_float_arr[2] = -60.03;" + "o.publicFloatArray = t_float_arr;");
    ...
    public void accessStaticFieldFloatArray() throws ScriptException {
        ...
        e.eval("var ts_float_arr = new (Java.type(\"float[]\"))(3);" + "ts_float_arr[0] = 9.0;" + "ts_float_arr[1] = 5.12345;"
                + "ts_float_arr[2] = -60.03;" + "SharedObject.publicStaticFloatArray = ts_float_arr;");
    ...
    public void accessFinalFloatArray() throws ScriptException {
        ...
        e.eval("var tf_float_arr = new (Java.type(\"float[]\"))(3);" + "tf_float_arr[0] = 9.0;" + "tf_float_arr[1] = 5.12345;"
                + "tf_float_arr[2] = -60.03;" + "o.publicFinalFloatArray = tf_float_arr;");
    ...
    public void accessStaticFinalFieldFloatArray() throws ScriptException {
        ...
        e.eval("var tsf_float_arr = new (Java.type(\"float[]\"))(3);" + "tsf_float_arr[0] = 9.0;" + "tsf_float_arr[1] = 5.12345;"
                + "tsf_float_arr[2] = -60.03;" + "SharedObject.publicStaticFinalFloatArray = tsf_float_arr;");
    ...
    public void accessFieldDoubleArrayRead() throws ScriptException {
        ...
        e.eval("var t_double_arr = new (Java.type(\"double[]\"))(3);" + "t_double_arr[0] = 9e10;" + "t_double_arr[1] = 0.677777;"
                + "t_double_arr[2] = -0.0000001;" + "o.publicDoubleArray = t_double_arr;");
    ...
    public void accessStaticFieldDoubleArrayRead() throws ScriptException {
        ...
        e.eval("var ts_double_arr = new (Java.type(\"double[]\"))(3);" + "ts_double_arr[0] = 9e10;" + "ts_double_arr[1] = 0.677777;"
                + "ts_double_arr[2] = -0.0000001;" + "SharedObject.publicStaticDoubleArray = ts_double_arr;");
    ...
    public void accessFinalFieldDoubleArrayRead() throws ScriptException {
        ...
        e.eval("var tf_double_arr = new (Java.type(\"double[]\"))(3);" + "tf_double_arr[0] = 9e10;" + "tf_double_arr[1] = 0.677777;"
                + "tf_double_arr[2] = -0.0000001;" + "o.publicFinalDoubleArray = tf_double_arr;");
    ...
    public void accessStaticFinalFieldDoubleArrayRead() throws ScriptException {
        ...
        e.eval("var tsf_double_arr = new (Java.type(\"double[]\"))(3);" + "tsf_double_arr[0] = 9e10;" + "tsf_double_arr[1] = 0.677777;"
                + "tsf_double_arr[2] = -0.0000001;" + "SharedObject.publicStaticFinalDoubleArray = tsf_double_arr;");
