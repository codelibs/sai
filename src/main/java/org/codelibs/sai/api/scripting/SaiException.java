...
/**
 * This is base exception for all Sai exceptions. These originate from
...
public abstract class SaiException extends RuntimeException {
     ...
     */
    protected SaiException(final String msg, final String fileName, final int line, final int column) {
     ...
     * @param column    column number
     */
    protected SaiException(final String msg, final Throwable cause, final String fileName, final int line, final int column) {
     ...
     * @param cause     exception cause
     */
    protected SaiException(final String msg, final Throwable cause) {
        super(msg, cause == null ? null : cause);
    ...
    /**
     * Get the source file name for this {@code SaiException}
     *
    ...
    /**
     * Set the source file name for this {@code SaiException}
     *
    ...
    /**
     * Get the line number for this {@code SaiException}
     *
    ...
    /**
     * Set the line number for this {@code SaiException}
     *
    ...
    /**
     * Get the column for this {@code SaiException}
     *
    ...
    /**
     * Set the column for this {@code SaiException}
     *
     ...
     */
    protected SaiException initEcmaError(final ScriptObject global) {
        if (ecmaError != null) {
