...
import static org.codelibs.sai.internal.parser.TokenType.ERROR;
import static org.codelibs.sai.internal.parser.TokenType.ESCSTRING;
import static org.codelibs.sai.internal.parser.TokenType.EXECSTRING;
import static org.codelibs.sai.internal.parser.TokenType.FLOATING;
import static org.codelibs.sai.internal.parser.TokenType.FUNCTION;
import static org.codelibs.sai.internal.parser.TokenType.HEXADECIMAL;
...
public class Lexer extends Scanner {
    ...
    private static final boolean XML_LITERALS = Options.getBooleanProperty("sai.lexer.xmlliterals");
    ...
    private static final String JAVASCRIPT_WHITESPACE_EOL = LFCR + "\u2028" + // line separator
            "\u2029" // paragraph separator
    ;
    private static final String JAVASCRIPT_WHITESPACE = SPACETAB + JAVASCRIPT_WHITESPACE_EOL + "\u000b" + // tabulation line
            "\u000c" + // ff (ctrl-l)
            "\u00a0" + // Latin-1 space
            "\u1680" + // Ogham space mark
