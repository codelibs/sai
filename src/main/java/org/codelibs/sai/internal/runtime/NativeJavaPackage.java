 ...
 * in Sai: {@code "Packages"}, {@code "java"}, and {@code "javax"}. Typical usages are:
 * <pre>
 ...
 * </pre>
 * You can also use {@link org.codelibs.sai.internal.objects.NativeJava#type(Object, Object)} to access Java classes. These two statements are mostly
 * equivalent:
 * <pre>
...
public final class NativeJavaPackage extends ScriptObject {
    ...
    /**
     * Public constructor to be accessible from {@link org.codelibs.sai.internal.objects.Global}
    ...
    private static GuardedInvocation createClassNotFoundInvocation(final CallSiteDescriptor desc) {
        ...
        return new GuardedInvocation(MH.dropArguments(CLASS_NOT_FOUND, 1, type.parameterList().subList(1, type.parameterCount())),
    ...
    protected Object invokeNoSuchProperty(final Object key, final boolean isScope, final int programPoint) {
        ...
        final Object retval = createProperty(String.valueOf(key));
