...
public final class SaiGuards {
    ...
    static boolean needsGuard(final Property property, final CallSiteDescriptor desc) {
        return property == null || property.isConfigurable() || property.isBound() || property.hasDualFields()
                || !SaiCallSiteDescriptor.isFastScope(desc) || property.canChangeType();
    }
    ...
    public static MethodHandle getGuard(final ScriptObject sobj, final Property property, final CallSiteDescriptor desc,
            final boolean explicitInstanceOfCheck) {
    ...
    private static MethodHandle findOwnMH(final String name, final Class<?> rtype, final Class<?>... types) {
        return MH.findStatic(MethodHandles.lookup(), SaiGuards.class, name, MH.type(rtype, types));
    }
}
