...
public abstract class Property implements Serializable {
    ...
    /**
     * Is this is a primitive field given to us by Saigen, i.e.
     ...
     * are running with {@code -Dsai.fields.objects=true}, the setters
    ...
    public String toString() {
        ...
        if (slot != -1) {
            sb.append(" [").append("slot=").append(slot).append(']');
        }
