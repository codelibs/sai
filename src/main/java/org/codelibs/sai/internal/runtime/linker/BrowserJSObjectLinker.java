...
import static org.codelibs.sai.internal.runtime.linker.BrowserJSObjectLinker.JSObjectHandles.JSOBJECT_CALL;
import static org.codelibs.sai.internal.runtime.linker.BrowserJSObjectLinker.JSObjectHandles.JSOBJECT_GETMEMBER;
import static org.codelibs.sai.internal.runtime.linker.BrowserJSObjectLinker.JSObjectHandles.JSOBJECT_GETSLOT;
import static org.codelibs.sai.internal.runtime.linker.BrowserJSObjectLinker.JSObjectHandles.JSOBJECT_SETMEMBER;
import static org.codelibs.sai.internal.runtime.linker.BrowserJSObjectLinker.JSObjectHandles.JSOBJECT_SETSLOT;
...
final class BrowserJSObjectLinker implements TypeBasedGuardingDynamicLinker {
    ...
    private final SaiBeansLinker saiBeansLinker;

    BrowserJSObjectLinker(final SaiBeansLinker saiBeansLinker) {
        this.saiBeansLinker = saiBeansLinker;
    }
    ...
    public GuardedInvocation getGuardedInvocation(final LinkRequest request, final LinkerServices linkerServices) throws Exception {
        final LinkRequest requestWithoutContext = request.withoutRuntimeContext(); // Sai has no runtime context
    ...
    private GuardedInvocation lookup(final CallSiteDescriptor desc, final LinkRequest request, final LinkerServices linkerServices)
        ...
        GuardedInvocation inv;
        try {
            inv = saiBeansLinker.getGuardedInvocation(request, linkerServices);
        } catch (Throwable th) {
            inv = null;
        }
    ...
    static class JSObjectHandles {
        ...
        static final MethodHandle JSOBJECT_GETMEMBER = findJSObjectMH_V("getMember", Object.class, String.class).asType(
                MH.type(Object.class, Object.class, String.class));
        static final MethodHandle JSOBJECT_GETSLOT = findJSObjectMH_V("getSlot", Object.class, int.class).asType(
                MH.type(Object.class, Object.class, int.class));
        static final MethodHandle JSOBJECT_SETMEMBER = findJSObjectMH_V("setMember", Void.TYPE, String.class, Object.class).asType(
                MH.type(Void.TYPE, Object.class, String.class, Object.class));
        static final MethodHandle JSOBJECT_SETSLOT = findJSObjectMH_V("setSlot", Void.TYPE, int.class, Object.class).asType(
                MH.type(Void.TYPE, Object.class, int.class, Object.class));
        static final MethodHandle JSOBJECT_CALL = findJSObjectMH_V("call", Object.class, String.class, Object[].class).asType(
                MH.type(Object.class, Object.class, String.class, Object[].class));
