...
public final class GlobalFunctions {
    ...
    public static final MethodHandle PARSEINT_Z = MH.dropArguments(
            MH.dropArguments(MH.constant(double.class, Double.NaN), 0, boolean.class), 0, Object.class);
    ...
    public static final MethodHandle IS_NAN_D = MH.dropArguments(
            MH.findStatic(MethodHandles.lookup(), Double.class, "isNaN", MH.type(boolean.class, double.class)), 0, Object.class);
