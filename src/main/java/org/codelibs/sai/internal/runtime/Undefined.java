...
public final class Undefined extends DefaultPropertyAccess {
    ...
    public static GuardedInvocation lookup(final CallSiteDescriptor desc) {
        ...
        case "new":
        case "call": {
            final String name = SaiCallSiteDescriptor.getFunctionDescription(desc);
    ...
    private static final MethodHandle SET_METHOD = MH.insertArguments(findOwnMH("set", void.class, Object.class, Object.class, int.class),
            3, SaiCallSiteDescriptor.CALLSITE_STRICT);
