...
public abstract class ArrayData {
     ...
     * of the wrong type
     */
    protected static final CompilerConstants.Call THROW_UNWARRANTED = staticCall(MethodHandles.lookup(), ArrayData.class,
            "throwUnwarranted", void.class, ArrayData.class, int.class, int.class);
    ...
    /**
      ...
      */
    public GuardedInvocation findFastCallMethod(final Class<? extends ArrayData> clazz, final CallSiteDescriptor desc,
     ...
     * @return fast property getter if one is found
     */
    public GuardedInvocation findFastGetMethod(final Class<? extends ArrayData> clazz, final CallSiteDescriptor desc,
            final LinkRequest request, final String operator) {
        return null;
    }
