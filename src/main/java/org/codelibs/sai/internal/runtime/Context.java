...
public final class Context {
     ...
     */
    public static final String NASHORN_SET_CONFIG = "sai.setConfig";

    /**
     * Permission needed to create Sai Context instance.
     */
    public static final String NASHORN_CREATE_CONTEXT = "sai.createContext";

    /**
     * Permission needed to create Sai Global instance.
     */
    public static final String NASHORN_CREATE_GLOBAL = "sai.createGlobal";

    /**
     * Permission to get current Sai Context from thread local storage.
     */
    public static final String NASHORN_GET_CONTEXT = "sai.getContext";

    /**
     * Permission to use Java reflection/jsr292 from script code.
     */
    public static final String NASHORN_JAVA_REFLECTION = "sai.JavaReflection";

    /**
     * Permission to enable sai debug mode.
     */
    public static final String NASHORN_DEBUG_MODE = "sai.debugMode";

    // sai load psuedo URL prefixes
    private static final String LOAD_CLASSPATH = "classpath:";
    private static final String LOAD_FX = "fx:";
    private static final String LOAD_NASHORN = "sai:";
