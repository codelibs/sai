...
/**
 * Internal linker for {@link StaticClass} objects, only ever used by Sai engine and not exposed to other engines.
 ...
 * </pre>
 */
final class SaiStaticClassLinker implements TypeBasedGuardingDynamicLinker {
    ...
    public GuardedInvocation getGuardedInvocation(final LinkRequest linkRequest, final LinkerServices linkerServices) throws Exception {
        final LinkRequest request = linkRequest.withoutRuntimeContext(); // Sai has no runtime context
        ...
        if ("new".equals(desc.getNameToken(CallSiteDescriptor.OPERATOR))) {
            ...
            if (SaiLinker.isAbstractClass(receiverClass)) {
                ...
                args[0] =
                        JavaAdapterFactory.getAdapterClassFor(new Class<?>[] { receiverClass }, null, linkRequest.getCallSiteDescriptor()
                                .getLookup());
