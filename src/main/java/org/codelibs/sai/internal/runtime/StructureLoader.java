...
import static org.codelibs.sai.internal.codegen.Compiler.binaryName;
 ...
 */
final class StructureLoader extends SaiLoader {
    ...
    /**
     * Returns true if the class name represents a Sai structure object.
     * @param name a class name
