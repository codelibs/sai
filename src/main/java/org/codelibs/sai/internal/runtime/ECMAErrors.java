...
import org.codelibs.sai.internal.scripts.JS;
...
public final class ECMAErrors {
    private static final String MESSAGES_RESOURCE = "org.codelibs.sai.internal.runtime.resources.Messages";
    ...
    */
     ...
     * by the resource tag. This is visible to, e.g. the {@link org.codelibs.sai.internal.parser.Parser}
    ...
    public static boolean isScriptFrame(final StackTraceElement frame) {
        ...
        if (className.startsWith(scriptPackage) && !CompilerConstants.isInternalMethodName(frame.getMethodName())) {
            ...
            // Make sure that it is not some Java code that Sai has in that package!
