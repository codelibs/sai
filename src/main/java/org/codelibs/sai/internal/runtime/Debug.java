...
import org.codelibs.sai.internal.parser.TokenStream;
import org.codelibs.sai.internal.parser.TokenType;

/**
 * Utilities for debugging Sai.
 *
 */
public final class Debug {
     ...
     * This is a shortcut for {@code SaiException.getScriptStackString(new Throwable())}.
     * @return formatted stack trace string
     */
    public static String scriptStack() {
        return SaiException.getScriptStackString(new Throwable());
    }
    ...
    public static String caller(final int depth, final int count, final String... ignores) {
        ...
        int c = count;
        loop: for (int i = depth + 1; i < callers.length && c != 0; i++) {
