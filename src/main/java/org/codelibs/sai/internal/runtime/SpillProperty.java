...
public class SpillProperty extends AccessorProperty {
    ...
    private static final MethodHandle PARRAY_GETTER = MH.asType(MH.getter(LOOKUP, ScriptObject.class, "primitiveSpill", long[].class),
            MH.type(long[].class, Object.class));
    private static final MethodHandle OARRAY_GETTER = MH.asType(MH.getter(LOOKUP, ScriptObject.class, "objectSpill", Object[].class),
    ...
    private static class Accessors {
        ...
        Accessors(final int slot) {
            assert slot >= 0;
            this.slot = slot;
            this.ensureSpillSize =
                    MH.asType(MH.insertArguments(ScriptObject.ENSURE_SPILL_SIZE, 1, slot), MH.type(Object.class, Object.class));
        }
     ...
     */
    @SuppressWarnings("this-escape")
    public SpillProperty(final Object key, final int flags, final int slot, final Class<?> initialType) {
        this(key, flags, slot);
