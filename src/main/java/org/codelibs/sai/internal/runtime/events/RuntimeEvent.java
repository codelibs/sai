...
package org.codelibs.sai.internal.runtime.events;

import java.util.logging.Level;

import org.codelibs.sai.internal.objects.NativeDebug;
...
public class RuntimeEvent<T> {
    ...
    public static final int RUNTIME_EVENT_QUEUE_SIZE = Options.getIntProperty("sai.runtime.event.queue.size", 1024);
    ...
    public String toString() {
        ...
        sb.append('[').append(level).append("] ").append(value == null ? "null" : getValueClass().getSimpleName()).append(" value=")
                .append(value);
