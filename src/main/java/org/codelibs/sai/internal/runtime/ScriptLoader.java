 ...
 *
 */
final class ScriptLoader extends SaiLoader {
    private static final String NASHORN_PKG_PREFIX = "org.codelibs.sai.internal.";
    ...
    protected Class<?> findClass(String name) throws ClassNotFoundException {
         ...
         * for sai's own classes or sai generated classes!
         */
    ...
    /**
     * Install a class for use by the Sai runtime
     *
