...
public final class UserAccessorProperty extends SpillProperty {
    ...
    private final static MethodHandle INVOKE_OBJECT_GETTER = findOwnMH_S("invokeObjectGetter", Object.class, Accessors.class,
            MethodHandle.class, Object.class);
    private final static MethodHandle INVOKE_INT_GETTER = findOwnMH_S("invokeIntGetter", int.class, Accessors.class, MethodHandle.class,
            int.class, Object.class);
    private final static MethodHandle INVOKE_NUMBER_GETTER = findOwnMH_S("invokeNumberGetter", double.class, Accessors.class,
            MethodHandle.class, int.class, Object.class);

    /** Setter method handle */
    private final static MethodHandle INVOKE_OBJECT_SETTER = findOwnMH_S("invokeObjectSetter", void.class, Accessors.class,
            MethodHandle.class, String.class, Object.class, Object.class);
    private final static MethodHandle INVOKE_INT_SETTER = findOwnMH_S("invokeIntSetter", void.class, Accessors.class, MethodHandle.class,
            String.class, Object.class, int.class);
    private final static MethodHandle INVOKE_NUMBER_SETTER = findOwnMH_S("invokeNumberSetter", void.class, Accessors.class,
            MethodHandle.class, String.class, Object.class, double.class);
    ...
    static MethodHandle getINVOKE_UA_GETTER(final Class<?> returnType, final int programPoint) {
        if (UnwarrantedOptimismException.isValid(programPoint)) {
            final int flags = SaiCallSiteDescriptor.CALLSITE_OPTIMISTIC | programPoint << CALLSITE_PROGRAM_POINT_SHIFT;
    ...
    public void setValue(final ScriptObject self, final ScriptObject owner, final Object value, final boolean strict) {
        try {
            invokeObjectSetter(getAccessors((owner != null) ? owner : self), getObjectSetterInvoker(), strict ? String.valueOf(getKey()) : null, self,
                    value);
        } catch (final Error | RuntimeException t) {
            throw t;
        } catch (final Throwable t) {
    ...
    @SuppressWarnings("unused")
    private static int invokeIntGetter(final Accessors gs, final MethodHandle invoker, final int programPoint, final Object self)
            throws Throwable {
        final Object func = gs.getter;
        if (func instanceof ScriptFunction) {
    ...
    @SuppressWarnings("unused")
    private static double invokeNumberGetter(final Accessors gs, final MethodHandle invoker, final int programPoint, final Object self)
            throws Throwable {
        final Object func = gs.getter;
        if (func instanceof ScriptFunction) {
    ...
    @SuppressWarnings("unused")
    private static void invokeObjectSetter(final Accessors gs, final MethodHandle invoker, final String name, final Object self,
    ...
    @SuppressWarnings("unused")
    private static void invokeIntSetter(final Accessors gs, final MethodHandle invoker, final String name, final Object self,
            final int value) throws Throwable {
        final Object func = gs.setter;
        if (func instanceof ScriptFunction) {
            invoker.invokeExact(func, self, value);
        } else if (name != null) {
    ...
    @SuppressWarnings("unused")
    private static void invokeNumberSetter(final Accessors gs, final MethodHandle invoker, final String name, final Object self,
            final double value) throws Throwable {
        final Object func = gs.setter;
        if (func instanceof ScriptFunction) {
            invoker.invokeExact(func, self, value);
        } else if (name != null) {
