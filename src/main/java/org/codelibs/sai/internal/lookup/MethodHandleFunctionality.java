...
/**
 * Wrapper for all method handle related functions used in Sai. This interface only exists
...
public interface MethodHandleFunctionality {
     ...
     * @return method handle for virtual method
     */
    public MethodHandle findSpecial(MethodHandles.Lookup explicitLookup, Class<?> clazz, String name, MethodType type,
