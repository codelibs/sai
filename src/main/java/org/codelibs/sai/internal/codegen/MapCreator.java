...
import org.codelibs.sai.internal.runtime.SpillProperty;
...
public class MapCreator<T> {
     ...
     */
    PropertyMap makeFieldMap(final boolean hasArguments, final boolean dualFields, final int fieldCount, final int fieldMaximum,
        ...
        for (final MapTuple<T> tuple : tuples) {
            ...
            if (symbol != null && !isValidArrayIndex(getArrayIndex(key))) {
                ...
                final Property property = new AccessorProperty(key, flags, structure, symbol.getFieldIndex(), initialType);
