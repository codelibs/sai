...
import static org.codelibs.sai.internal.codegen.ClassEmitter.Flag.PRIVATE;
import static org.codelibs.sai.internal.codegen.ClassEmitter.Flag.STATIC;
import static org.codelibs.sai.internal.codegen.CompilerConstants.ARGUMENTS;
import static org.codelibs.sai.internal.codegen.CompilerConstants.CALLEE;
import static org.codelibs.sai.internal.codegen.CompilerConstants.CREATE_PROGRAM_FUNCTION;
import static org.codelibs.sai.internal.codegen.CompilerConstants.GET_MAP;
import static org.codelibs.sai.internal.codegen.CompilerConstants.GET_STRING;
import static org.codelibs.sai.internal.codegen.CompilerConstants.QUICK_PREFIX;
import static org.codelibs.sai.internal.codegen.CompilerConstants.REGEX_PREFIX;
import static org.codelibs.sai.internal.codegen.CompilerConstants.SCOPE;
import static org.codelibs.sai.internal.codegen.CompilerConstants.SPLIT_PREFIX;
import static org.codelibs.sai.internal.codegen.CompilerConstants.THIS;
import static org.codelibs.sai.internal.codegen.CompilerConstants.VARARGS;
import static org.codelibs.sai.internal.codegen.CompilerConstants.interfaceCallNoLookup;
import static org.codelibs.sai.internal.codegen.CompilerConstants.methodDescriptor;
...
import static org.codelibs.sai.internal.ir.Symbol.HAS_SLOT;
import static org.codelibs.sai.internal.ir.Symbol.IS_INTERNAL;
...
import static org.codelibs.sai.internal.runtime.linker.SaiCallSiteDescriptor.CALLSITE_APPLY_TO_CALL;
import static org.codelibs.sai.internal.runtime.linker.SaiCallSiteDescriptor.CALLSITE_DECLARE;
import static org.codelibs.sai.internal.runtime.linker.SaiCallSiteDescriptor.CALLSITE_FAST_SCOPE;
import static org.codelibs.sai.internal.runtime.linker.SaiCallSiteDescriptor.CALLSITE_OPTIMISTIC;
import static org.codelibs.sai.internal.runtime.linker.SaiCallSiteDescriptor.CALLSITE_PROGRAM_POINT_SHIFT;
import static org.codelibs.sai.internal.runtime.linker.SaiCallSiteDescriptor.CALLSITE_SCOPE;
...
import org.codelibs.sai.internal.AssertsEnabled;
import org.codelibs.sai.internal.IntDeque;
import org.codelibs.sai.internal.codegen.ClassEmitter.Flag;
import org.codelibs.sai.internal.codegen.CompilerConstants.Call;
import org.codelibs.sai.internal.codegen.types.ArrayType;
...
import org.codelibs.sai.internal.ir.GetSplitState;
...
import org.codelibs.sai.internal.ir.JumpStatement;
import org.codelibs.sai.internal.ir.JumpToInlinedFinally;
import org.codelibs.sai.internal.ir.LabelNode;
import org.codelibs.sai.internal.ir.LexicalContext;
import org.codelibs.sai.internal.ir.LexicalContextNode;
import org.codelibs.sai.internal.ir.LiteralNode;
import org.codelibs.sai.internal.ir.LiteralNode.ArrayLiteralNode;
import org.codelibs.sai.internal.ir.LiteralNode.PrimitiveLiteralNode;
import org.codelibs.sai.internal.ir.LocalVariableConversion;
...
import org.codelibs.sai.internal.ir.RuntimeNode.Request;
import org.codelibs.sai.internal.ir.SetSplitState;
import org.codelibs.sai.internal.ir.SplitReturn;
import org.codelibs.sai.internal.ir.Splittable;
...
import org.codelibs.sai.internal.ir.visitor.NodeOperatorVisitor;
import org.codelibs.sai.internal.ir.visitor.SimpleNodeVisitor;
import org.codelibs.sai.internal.objects.Global;
import org.codelibs.sai.internal.parser.Lexer.RegexToken;
import org.codelibs.sai.internal.parser.TokenType;
import org.codelibs.sai.internal.runtime.Context;
import org.codelibs.sai.internal.runtime.Debug;
import org.codelibs.sai.internal.runtime.ECMAException;
import org.codelibs.sai.internal.runtime.JSType;
import org.codelibs.sai.internal.runtime.OptimisticReturnFilters;
...
import org.codelibs.sai.internal.runtime.RewriteException;
import org.codelibs.sai.internal.runtime.Scope;
...
final class CodeGenerator extends NodeOperatorVisitor<CodeGeneratorLexicalContext> implements Loggable {
    ...
    private static final Call CREATE_REWRITE_EXCEPTION = CompilerConstants.staticCallNoLookup(RewriteException.class, "create",
            RewriteException.class, UnwarrantedOptimismException.class, Object[].class, String[].class);
    private static final Call CREATE_REWRITE_EXCEPTION_REST_OF = CompilerConstants.staticCallNoLookup(RewriteException.class, "create",
            RewriteException.class, UnwarrantedOptimismException.class, Object[].class, String[].class, int[].class);

    private static final Call ENSURE_INT = CompilerConstants.staticCallNoLookup(OptimisticReturnFilters.class, "ensureInt", int.class,
            Object.class, int.class);
    private static final Call ENSURE_NUMBER = CompilerConstants.staticCallNoLookup(OptimisticReturnFilters.class, "ensureNumber",
            double.class, Object.class, int.class);

    private static final Call CREATE_FUNCTION_OBJECT = CompilerConstants.staticCallNoLookup(ScriptFunction.class, "create",
            ScriptFunction.class, Object[].class, int.class, ScriptObject.class);
    private static final Call CREATE_FUNCTION_OBJECT_NO_SCOPE = CompilerConstants.staticCallNoLookup(ScriptFunction.class, "create",
            ScriptFunction.class, Object[].class, int.class);

    private static final Call TO_NUMBER_FOR_EQ = CompilerConstants.staticCallNoLookup(JSType.class, "toNumberForEq", double.class,
            Object.class);
    private static final Call TO_NUMBER_FOR_STRICT_EQ = CompilerConstants.staticCallNoLookup(JSType.class, "toNumberForStrictEq",
    ...
    static final int OBJECT_SPILL_THRESHOLD = Options.getIntProperty("sai.spill.threshold", 256);
    ...
    private boolean isFastScope(final Symbol symbol) {
        ...
        for (final Iterator<LexicalContextNode> it = lc.getAllNodes(); it.hasNext();) {
            ...
            if (node instanceof Block) {
                ...
                if (node instanceof WithNode && previousWasBlock || node instanceof FunctionNode
                        && ((FunctionNode) node).needsDynamicScope()) {
    ...
    MethodEmitter loadBinaryOperands(final BinaryNode binaryNode) {
        return loadBinaryOperands(binaryNode.lhs(), binaryNode.rhs(), TypeBounds.UNBOUNDED.notWiderThan(binaryNode.getWidestOperandType()),
                false, false);
    }

    private MethodEmitter loadBinaryOperands(final Expression lhs, final Expression rhs, final TypeBounds explicitOperandBounds,
            final boolean baseAlreadyOnStack, final boolean forceConversionSeparation) {
    ...
    public Node leaveBlock(final Block block) {
        ...
        lc.releaseSlots();
        assert !method.isReachable() || (lc.isFunctionBody() ? 0 : lc.getUsedSlotCount()) == method.getFirstTemp() : "reachable="
                + method.isReachable() + " isFunctionBody=" + lc.isFunctionBody() + " usedSlotCount=" + lc.getUsedSlotCount()
        ...
        function.accept(new SimpleNodeVisitor() {
            private MethodEmitter sharedScopeCall(final IdentNode identNode, final int flags) {
                ...
                new OptimisticOperation(callNode, resultBounds) {
                    ...
                    void consumeStack() {
                        ...
                        final SharedScopeCall scopeCall =
                                codegenLexicalContext.getScopeCall(unit, symbol, identNode.getType(), resultBounds.widest, paramTypes,
                                        flags);
            ...
            public boolean enterIdentNode(final IdentNode node) {
                ...
                if (symbol.isScope()) {
                    ...
                    if (callNode.isEval()) {
                        evalCall(node, flags);
                    } else if (useCount <= SharedScopeCall.FAST_SCOPE_CALL_THRESHOLD || !isFastScope(symbol)
                            && useCount <= SharedScopeCall.SLOW_SCOPE_CALL_THRESHOLD || CodeGenerator.this.lc.inDynamicScope()
                            || callNode.isOptimistic()) {
                        scopeCall(node, flags);
                    } else {
                        sharedScopeCall(node, flags);
                    }
                    assert method.peekType().equals(resultBounds.within(callNode.getType())) : method.peekType() + " != " + resultBounds
                            + "(" + callNode.getType() + ")";
                } else {
                    enterDefault(node);
                }
    ...
    private void initLocals(final Block block) {
        ...
        if (block.needsScope()) {
            ...
            for (final Symbol symbol : block.getSymbols()) {
                ...
                if (symbol.isVar()) {
                    ...
                    assert symbol.isScope() : "scope for " + symbol + " should have been set in AssignSymbols already "
                            + function.getName() + " varsInScope=" + varsInScope + " hasArguments=" + hasArguments + " symbol.isScope()="
                            + symbol.isScope();
                    assert !(hasArguments && symbol.hasSlot()) : "slot for " + symbol + " should have been removed in Lower already "
                            + function.getName();
        ...
        printSymbols(block, function, (isFunctionBody ? "Function " : "Block in ")
                + (function.getIdent() == null ? "<anonymous>" : function.getIdent().getName()));
    }
    ...
    private void initializeInternalFunctionParameter(final CompilerConstants cc, final FunctionNode fn, final Label functionStart,
            final int slot) {
    ...
    private Symbol initializeInternalFunctionOrSplitParameter(final CompilerConstants cc, final FunctionNode fn, final Label functionStart,
            final int slot) {
    ...
    /**
     * Parameters come into the method packed into local variable slots next to each other. Sai on the other hand
    ...
    public Node leaveFunctionNode(final FunctionNode functionNode) {
        try {
            ...
            final VerifyError e =
                    new VerifyError("Code generation bug in \"" + functionNode.getName() + "\": likely stack misaligned: " + t + " "
                            + functionNode.getSource().getName());
            e.initCause(t);
            throw e;
        }
    }
    ...
    private void loadObjectNode(final ObjectNode objectNode) {
        ...
        for (final PropertyNode propertyNode : elements) {
            ...
            final Class<?> valueType =
                    (!useDualFields() || value == null || value.getType().isBoolean()) ? Object.class : value.getType().getTypeClass();
    ...
    private void loadRuntimeNode(final RuntimeNode runtimeNode) {
        ...
        method.invokestatic(CompilerConstants.className(ScriptRuntime.class), newRuntimeNode.getRequest().toString(),
                new FunctionSignature(false, false, newRuntimeNode.getType(), args.size()).toString());
    ...
    public boolean enterSwitchNode(final SwitchNode switchNode) {
        ...
        if (switchNode.isUniqueInteger()) {
            ...
            if (!type.isInteger()) {
                ...
                method.invoke(staticCallNoLookup(ScriptRuntime.class, "switchTagAsInt", int.class, exprClass.isPrimitive() ? exprClass
                        : Object.class, int.class));
            }
        ...
        new OptimisticOperation(binaryNode, resultBounds) {
            ...
            void loadStack() {
                ...
                if (isOptimistic) {
                    ...
                    operandBounds =
                            new TypeBounds(Type.narrowest(binaryNode.getWidestOperandType(), resultBounds.widest), widestOperationType);
                ...
                void loadStack() {
                    ...
                    if (isValid(getProgramPoint()) || widestOperationType == Type.NUMBER) {
                        ...
                        final Type operandType =
                                Type.widest(booleanToInt(objectToNumber(lhs.getType())), booleanToInt(objectToNumber(rhs.getType())));
    ...
    private abstract class BinarySelfAssignment extends SelfModifyingStore<BinaryNode> {
        ...
        @Override
        protected void evaluate() {
            loadBinaryOperands(assignNode.lhs(), assignNode.rhs(), TypeBounds.UNBOUNDED.notWiderThan(assignNode.getWidestOperandType()),
                    true, false);
            op();
        }
    }
    ...
    private void loadTernaryNode(final TernaryNode ternaryNode, final TypeBounds resultBounds) {
        ...
        final Type outNarrowest =
                Type.narrowest(resultBounds.widest, Type.generic(Type.widestReturnType(trueExpr.getType(), falseExpr.getType())));
        ...
        if (functionNode.isProgram() && !compiler.isOnDemandCompilation()) {
            final MethodEmitter createFunction =
                    functionNode
                            .getCompileUnit()
                            .getClassEmitter()
                            .method(EnumSet.of(Flag.PUBLIC, Flag.STATIC), CREATE_PROGRAM_FUNCTION.symbolName(), ScriptFunction.class,
                                    ScriptObject.class);
    ...
    private MethodEmitter globalAllocateArguments() {
        return method.invokestatic(GLOBAL_OBJECT, "allocateArguments",
                methodDescriptor(ScriptObject.class, Object[].class, Object.class, int.class));
    }
    ...
    private MethodEmitter globalAllocateArray(final ArrayType type) {
        ...
        return method.invokestatic(GLOBAL_OBJECT, "allocate", "(" + type.getDescriptor() + ")Lorg/codelibs/sai/internal/objects/NativeArray;");
    }
    ...
    private MethodEmitter globalReplaceLocationPropertyPlaceholder() {
        return method.invokestatic(GLOBAL_OBJECT, "replaceLocationPropertyPlaceholder",
                methodDescriptor(Object.class, Object.class, Object.class));
    }
    ...
    private abstract class OptimisticOperation {
        ...
        MethodEmitter emit(final int ignoredArgCount) {
            ...
            if (isOptimistic || currentContinuationEntryPoint) {
                ...
                assert everyStackValueIsLocalLoad(localLoads) : Arrays.toString(localLoads) + ", " + stackSizeOnEntry + ", "
                        + ignoredArgCount;
    ...
    private void generateContinuationHandler() {
        ...
        // Sai has a bug), then line number 0 will be an indication of where it came from (line numbers are Uint16).
        method.lineNumber(0);
        ...
        if (!isStackEmpty) {
            ...
            for (int i = 0; i < stackStoreSpec.length; ++i) {
                ...
                if (map != null) {
                    method.dup();
                    assert ScriptObject.class.isAssignableFrom(method.peekType().getTypeClass()) : method.peekType().getTypeClass()
