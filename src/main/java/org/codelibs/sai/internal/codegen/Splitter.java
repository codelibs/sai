...
final class Splitter extends SimpleNodeVisitor implements Loggable {
    ...
    public static final long SPLIT_THRESHOLD = Options.getIntProperty("sai.compiler.splitter.threshold", 32 * 1024);
     ...
     */
    private SplitNode createBlockSplitNode(final Block parent, final FunctionNode function, final List<Statement> statements,
            final long weight) {
