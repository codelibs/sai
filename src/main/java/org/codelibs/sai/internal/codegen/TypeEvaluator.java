...
import static org.codelibs.sai.internal.runtime.Property.NOT_CONFIGURABLE;
import static org.codelibs.sai.internal.runtime.Property.NOT_ENUMERABLE;
import static org.codelibs.sai.internal.runtime.Property.NOT_WRITABLE;
...
final class TypeEvaluator {
    ...
    void declareLocalSymbol(final String symbolName) {
        assert compiler.useOptimisticTypes() && compiler.isOnDemandCompilation() && runtimeScope != null : "useOptimistic="
                + compiler.useOptimisticTypes() + " isOnDemand=" + compiler.isOnDemandCompilation() + " scope=" + runtimeScope;
