...
import org.codelibs.sai.internal.parser.Lexer.LexerToken;
...
public abstract class LiteralNode<T> extends Expression implements PropertyKey {
    ...
    public static final class ArrayLiteralNode extends LiteralNode<Expression[]> implements LexicalContextNode, Splittable {
         ...
         */
        private ArrayLiteralNode(final ArrayLiteralNode node, final Expression[] value, final Type elementType, final int[] postsets,
                final Object presets, final List<Splittable.SplitRange> splitRanges) {
            super(node, value);
