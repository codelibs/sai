...
import static org.codelibs.sai.internal.runtime.linker.SaiCallSiteDescriptor.CALLSITE_PROFILE;
import static org.codelibs.sai.internal.runtime.linker.SaiCallSiteDescriptor.CALLSITE_STRICT;
import static org.codelibs.sai.internal.runtime.linker.SaiCallSiteDescriptor.CALLSITE_TRACE;
import static org.codelibs.sai.internal.runtime.linker.SaiCallSiteDescriptor.CALLSITE_TRACE_ENTEREXIT;
import static org.codelibs.sai.internal.runtime.linker.SaiCallSiteDescriptor.CALLSITE_TRACE_MISSES;
import static org.codelibs.sai.internal.runtime.linker.SaiCallSiteDescriptor.CALLSITE_TRACE_VALUES;
...
import org.codelibs.sai.internal.ir.annotations.Ignore;
...
import org.codelibs.sai.internal.runtime.UserAccessorProperty;
...
public final class FunctionNode extends LexicalContextExpression implements Flags<FunctionNode>, CompileUnitHolder {
     ...
     */
    public FunctionNode(final Source source, final int lineNumber, final long token, final int finish, final long firstToken,
            final Namespace namespace, final IdentNode ident, final String name, final List<IdentNode> parameters,
            final FunctionNode.Kind kind, final int flags) {
        super(token, finish);
    ...
    private FunctionNode(final FunctionNode functionNode, final long lastToken, final Object endParserState, final int flags,
            final String name, final Type returnType, final CompileUnit compileUnit, final Block body, final List<IdentNode> parameters,
            final int thisProperties, final Class<?> rootClass, final Source source, final Namespace namespace) {
        super(functionNode);
    ...
    public FunctionNode initializeDeserialized(final Source source, final Namespace namespace) {
        ...
        return new FunctionNode(this, lastToken, endParserState, flags, name, returnType, compileUnit, body, parameters, thisProperties,
    ...
    /**
     * Function to parse sai per-function extension directive comments.
     *
     * @param directive sai extension directive string
     * @return integer flag for the given directive.
     */
    public static int getDirectiveFlag(final String directive) {
        switch (directive) {
        case "sai callsite trace enterexit":
            return IS_TRACE_ENTEREXIT;
        case "sai callsite trace misses":
            return IS_TRACE_MISSES;
        case "sai callsite trace objects":
            return IS_TRACE_VALUES;
        case "sai callsite profile":
            return IS_PROFILE;
        case "sai print parse":
            return IS_PRINT_PARSE;
        case "sai print lower parse":
            return IS_PRINT_LOWER_PARSE;
        case "sai print ast":
            return IS_PRINT_AST;
        case "sai print lower ast":
            return IS_PRINT_LOWER_AST;
        case "sai print symbols":
    ...
    public void toString(final StringBuilder sb, final boolean printTypes) {
        sb.append('[').append(returnType).append(']').append(' ');
    ...
    public FunctionNode setFlags(final LexicalContext lc, final int flags) {
        ...
        return Node.replaceInLexicalContext(lc, this, new FunctionNode(this, lastToken, endParserState, flags, name, returnType,
                compileUnit, body, parameters, thisProperties, rootClass, source, namespace));
    }
    ...
    public FunctionNode setBody(final LexicalContext lc, final Block body) {
        ...
        return Node.replaceInLexicalContext(lc, this, new FunctionNode(this, lastToken, endParserState, flags
                | (body.needsScope() ? FunctionNode.HAS_SCOPE_BLOCK : 0), name, returnType, compileUnit, body, parameters, thisProperties,
                rootClass, source, namespace));
    }
    ...
    public FunctionNode setReturnType(final LexicalContext lc, final Type returnType) {
        ...
        return Node.replaceInLexicalContext(lc, this, new FunctionNode(this, lastToken, endParserState, flags, name, type, compileUnit,
                body, parameters, thisProperties, rootClass, source, namespace));
    }
