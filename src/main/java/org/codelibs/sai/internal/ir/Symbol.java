...
public final class Symbol implements Comparable<Symbol>, Cloneable, Serializable {
    ...
    static {
        final String stacktrace = Options.getStringProperty("sai.compiler.symbol.stacktrace", null);
        final String trace;
        if (stacktrace != null) {
            ...
            trace = Options.getStringProperty("sai.compiler.symbol.trace", null);
    ...
    void print(final PrintWriter stream) {
        ...
        sb.append(align(name, 20)).append(": ").append(", ").append(align(firstSlot == -1 ? "none" : "" + firstSlot, 10));
    ...
    public int slotCount() {
        return ((flags & HAS_INT_VALUE) == 0 ? 0 : 1) + ((flags & HAS_DOUBLE_VALUE) == 0 ? 0 : 2)
    ...
    public String toString() {
        ...
        if (hasSlot()) {
            sb.append(' ').append('(').append("slot=").append(firstSlot).append(' ');
