...
import static org.codelibs.sai.internal.codegen.CompilerConstants.__DIR__;
import static org.codelibs.sai.internal.codegen.CompilerConstants.__FILE__;
import static org.codelibs.sai.internal.codegen.CompilerConstants.__LINE__;
...
public final class IdentNode extends Expression implements PropertyKey, FunctionCall, Optimistic, JoinPredecessor {
    ...
    private IdentNode(final IdentNode identNode, final String name, final Type type, final int flags, final int programPoint,
