...
public final class NativeInt16Array extends ArrayBufferView {
    ...
    private static final class Int16ArrayData extends TypedArrayData<ShortBuffer> {
        ...
        private static final MethodHandle GET_ELEM = specialCall(MethodHandles.lookup(), Int16ArrayData.class, "getElem", int.class,
                int.class).methodHandle();
        private static final MethodHandle SET_ELEM = specialCall(MethodHandles.lookup(), Int16ArrayData.class, "setElem", void.class,
     ...
     * @return a new Int16Array holding the elements
     */
    @Function(attributes = Attribute.NOT_ENUMERABLE, arity = 0, where = Where.CONSTRUCTOR)
    public static NativeInt16Array of(final Object self, final Object... items) {
        return (NativeInt16Array) ArrayBufferView.ofImpl(FACTORY, items);
    }
    ...
    public static NativeInt16Array from(final Object self, final Object... args) {
        return (NativeInt16Array) ArrayBufferView.fromImpl(FACTORY, args);
    }
