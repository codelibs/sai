...
public final class NativeUint8Array extends ArrayBufferView {
    ...
    private static final class Uint8ArrayData extends TypedArrayData<ByteBuffer> {
        ...
        private static final MethodHandle GET_ELEM = specialCall(MethodHandles.lookup(), Uint8ArrayData.class, "getElem", int.class,
                int.class).methodHandle();
        private static final MethodHandle SET_ELEM = specialCall(MethodHandles.lookup(), Uint8ArrayData.class, "setElem", void.class,
     ...
     * @return a new Uint8Array holding the elements
     */
    @Function(attributes = Attribute.NOT_ENUMERABLE, arity = 0, where = Where.CONSTRUCTOR)
    public static NativeUint8Array of(final Object self, final Object... items) {
        return (NativeUint8Array) ArrayBufferView.ofImpl(FACTORY, items);
    }
    ...
    public static NativeUint8Array from(final Object self, final Object... args) {
        return (NativeUint8Array) ArrayBufferView.fromImpl(FACTORY, args);
    }
