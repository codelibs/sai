...
public final class NativeFloat64Array extends ArrayBufferView {
    ...
    private static final class Float64ArrayData extends TypedArrayData<DoubleBuffer> {
        ...
        private static final MethodHandle GET_ELEM = specialCall(MethodHandles.lookup(), Float64ArrayData.class, "getElem", double.class,
                int.class).methodHandle();
        private static final MethodHandle SET_ELEM = specialCall(MethodHandles.lookup(), Float64ArrayData.class, "setElem", void.class,
