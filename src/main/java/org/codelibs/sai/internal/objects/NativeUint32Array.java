...
public final class NativeUint32Array extends ArrayBufferView {
    ...
    private static final class Uint32ArrayData extends TypedArrayData<IntBuffer> {
        ...
        private static final MethodHandle GET_ELEM = specialCall(MethodHandles.lookup(), Uint32ArrayData.class, "getElem", double.class,
                int.class).methodHandle();
        private static final MethodHandle SET_ELEM = specialCall(MethodHandles.lookup(), Uint32ArrayData.class, "setElem", void.class,
     ...
     * @return a new Uint32Array holding the elements
     */
    @Function(attributes = Attribute.NOT_ENUMERABLE, arity = 0, where = Where.CONSTRUCTOR)
    public static NativeUint32Array of(final Object self, final Object... items) {
        return (NativeUint32Array) ArrayBufferView.ofImpl(FACTORY, items);
    }
    ...
    public static NativeUint32Array from(final Object self, final Object... args) {
        return (NativeUint32Array) ArrayBufferView.fromImpl(FACTORY, args);
    }
