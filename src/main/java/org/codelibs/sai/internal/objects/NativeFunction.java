...
public final class NativeFunction {
    ...
    public static final MethodHandle TO_APPLY_ARGS = Lookup.findOwnStatic(MethodHandles.lookup(), "toApplyArgs", Object[].class,
            Object.class);
    ...
    /**
     * Sai extension: Function.prototype.toSource
     *
     * @param self self reference
