...
public final class NativeInt8Array extends ArrayBufferView {
    ...
    private static final class Int8ArrayData extends TypedArrayData<ByteBuffer> {
        ...
        private static final MethodHandle GET_ELEM = specialCall(MethodHandles.lookup(), Int8ArrayData.class, "getElem", int.class,
                int.class).methodHandle();
        private static final MethodHandle SET_ELEM = specialCall(MethodHandles.lookup(), Int8ArrayData.class, "setElem", void.class,
     ...
     * @return a new Int8Array holding the elements
     */
    @Function(attributes = Attribute.NOT_ENUMERABLE, arity = 0, where = Where.CONSTRUCTOR)
    public static NativeInt8Array of(final Object self, final Object... items) {
        return (NativeInt8Array) ArrayBufferView.ofImpl(FACTORY, items);
    }
    ...
    public static NativeInt8Array from(final Object self, final Object... args) {
        return (NativeInt8Array) ArrayBufferView.fromImpl(FACTORY, args);
    }
