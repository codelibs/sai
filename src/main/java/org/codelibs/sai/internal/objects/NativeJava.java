...
import org.codelibs.sai.internal.runtime.ListAdapter;
...
/**
 * This class is the implementation for the {@code Java} global object exposed to programs running under Sai. This
...
public final class NativeJava {
    ...
    /**
     * <p>
     * Given a name of a Java type, returns an object representing that type in Sai. The Java class of the objects
     * used to represent Java types in Sai is not {@link java.lang.Class} but rather {@link StaticClass}. They are
     * the objects that you can use with the {@code new} operator to create new instances of the class as well as to
     * access static members of the class. In Sai, {@code Class} objects are just regular Java objects that aren't
     ...
     * </pre>
     * <p>
     * Sai supports a syntactic extension where a "new" expression followed by an argument is identical to
     ...
     * you can just pass in a function object, and Sai will know what you meant:
     * </p>
     * <pre>
     ...
     * </pre>
     * <p>
     * Here, {@code Timer.schedule()} expects a {@code TimerTask} as its argument, so Sai creates an instance of a
     ...
     * that in most cases, you can use Java arrays and lists natively in Sai; in cases where for some reason you
     ...
     * <ul>
     * <li>Every specified list of Java types will have one extender subclass in Sai per caller protection domain -
     ...
     * API is required as otherwise Sai exposes all objects externally as {@link JSObject}s that also implement the
