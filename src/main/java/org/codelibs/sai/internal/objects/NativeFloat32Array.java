...
public final class NativeFloat32Array extends ArrayBufferView {
    ...
    private static final class Float32ArrayData extends TypedArrayData<FloatBuffer> {
        ...
        private static final MethodHandle GET_ELEM = specialCall(MethodHandles.lookup(), Float32ArrayData.class, "getElem", double.class,
                int.class).methodHandle();
        private static final MethodHandle SET_ELEM = specialCall(MethodHandles.lookup(), Float32ArrayData.class, "setElem", void.class,
     ...
     * @return a new Float32Array holding the elements
     */
    @Function(attributes = Attribute.NOT_ENUMERABLE, arity = 0, where = Where.CONSTRUCTOR)
    public static NativeFloat32Array of(final Object self, final Object... items) {
        return (NativeFloat32Array) ArrayBufferView.ofImpl(FACTORY, items);
    }
    ...
    public static NativeFloat32Array from(final Object self, final Object... args) {
        return (NativeFloat32Array) ArrayBufferView.fromImpl(FACTORY, args);
    }
