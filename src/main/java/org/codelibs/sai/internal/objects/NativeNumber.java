...
public final class NativeNumber extends ScriptObject {
    ...
    NativeNumber(final double value, final Global global) {
        this(value, global.getNumberPrototype(), $saigenmap$);
    }
    ...
    public static GuardedInvocation lookupPrimitive(final LinkRequest request, final Object receiver) {
        return PrimitiveLookup.lookupPrimitive(request, SaiGuards.getNumberGuard(), new NativeNumber(((Number) receiver).doubleValue()),
                WRAPFILTER, PROTOFILTER);
    }
