...
public final class NativeInt32Array extends ArrayBufferView {
    ...
    private static final class Int32ArrayData extends TypedArrayData<IntBuffer> {
        ...
        private static final MethodHandle GET_ELEM = specialCall(MethodHandles.lookup(), Int32ArrayData.class, "getElem", int.class,
                int.class).methodHandle();
        private static final MethodHandle SET_ELEM = specialCall(MethodHandles.lookup(), Int32ArrayData.class, "setElem", void.class,
