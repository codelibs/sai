...
import static org.codelibs.sai.internal.runtime.arrays.ArrayLikeIterator.arrayLikeIterator;
import static org.codelibs.sai.internal.runtime.arrays.ArrayLikeIterator.reverseArrayLikeIterator;
...
import org.codelibs.sai.internal.runtime.arrays.ContinuousArrayData;
import org.codelibs.sai.internal.runtime.arrays.IntElements;
import org.codelibs.sai.internal.runtime.arrays.IteratorAction;
import org.codelibs.sai.internal.runtime.arrays.NumericElements;
...
public final class NativeArray extends ScriptObject implements OptimisticBuiltins {
    ...
    NativeArray(final ArrayData arrayData, final Global global) {
        super(global.getArrayPrototype(), $saigenmap$);
        setArray(arrayData);
        setIsArray();
    }
    ...
    private static MethodHandle getREDUCE_CALLBACK_INVOKER() {
        return Global.instance().getDynamicInvoker(REDUCE_CALLBACK_INVOKER, new Callable<MethodHandle>() {
            @Override
            public MethodHandle call() {
                return Bootstrap.createDynamicInvoker("dyn:call", Object.class, Object.class, Undefined.class, Object.class, Object.class,
    ...
    public static Object getProtoLength(final Object self) {
        return length(self); // Same as instance getter but we can't make saigen use the same method for prototype
    }
    ...
    public static void setProtoLength(final Object self, final Object length) {
        length(self, length); // Same as instance setter but we can't make saigen use the same method for prototype
    }
    ...
    public static NativeArray concat(final Object self, final Object arg) {
        ...
        if (arg instanceof NativeArray) {
            ...
            if (argData.isEmpty()) {
                ...
                newData =
                        ((ContinuousArrayData) selfData.convert(widestElementType)).fastConcat((ContinuousArrayData) argData
                                .convert(widestElementType));
            }
        } else {
