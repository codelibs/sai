...
import org.codelibs.sai.internal.runtime.BitVector;
...
public final class NativeRegExp extends ScriptObject {
    ...
    private NativeRegExp(final Global global) {
        super(global.getRegExpPrototype(), $saigenmap$);
    ...
    /**
     * Sai extension: RegExp.prototype.compile - everybody implements this!
     *
     * @param self    self reference
     * @param pattern pattern
     * @param flags   flags
    ...
    private String callReplaceValue(final MethodHandle invoker, final Object function, final Object self, final RegExpMatcher matcher,
            final String string) throws Throwable {
