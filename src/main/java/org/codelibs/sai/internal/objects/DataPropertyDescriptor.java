...
import static org.codelibs.sai.internal.runtime.ScriptRuntime.sameValue;
...
public final class DataPropertyDescriptor extends ScriptObject implements PropertyDescriptor {
    ...
    DataPropertyDescriptor(final boolean configurable, final boolean enumerable, final boolean writable, final Object value,
            final Global global) {
        super(global.getObjectPrototype(), $saigenmap$);
    ...
    public boolean hasAndEquals(final PropertyDescriptor otherDesc) {
        ...
        return (!has(CONFIGURABLE) || sameValue(configurable, other.configurable))
                && (!has(ENUMERABLE) || sameValue(enumerable, other.enumerable)) && (!has(WRITABLE) || sameValue(writable, other.writable))
    ...
    public boolean equals(final Object obj) {
        ...
        return sameValue(configurable, other.configurable) && sameValue(enumerable, other.enumerable)
                && sameValue(writable, other.writable) && sameValue(value, other.value);
    }

    @Override
    public String toString() {
        return '[' + getClass().getSimpleName() + " {configurable=" + configurable + " enumerable=" + enumerable + " writable=" + writable
                + " value=" + value + "}]";
    }
