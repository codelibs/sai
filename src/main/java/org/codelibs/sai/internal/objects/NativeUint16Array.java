...
public final class NativeUint16Array extends ArrayBufferView {
    ...
    private static final class Uint16ArrayData extends TypedArrayData<CharBuffer> {
        ...
        private static final MethodHandle GET_ELEM = specialCall(MethodHandles.lookup(), Uint16ArrayData.class, "getElem", int.class,
                int.class).methodHandle();
        private static final MethodHandle SET_ELEM = specialCall(MethodHandles.lookup(), Uint16ArrayData.class, "setElem", void.class,
     ...
     * @return a new Uint16Array holding the elements
     */
    @Function(attributes = Attribute.NOT_ENUMERABLE, arity = 0, where = Where.CONSTRUCTOR)
    public static NativeUint16Array of(final Object self, final Object... items) {
        return (NativeUint16Array) ArrayBufferView.ofImpl(FACTORY, items);
    }
    ...
    public static NativeUint16Array from(final Object self, final Object... args) {
        return (NativeUint16Array) ArrayBufferView.fromImpl(FACTORY, args);
    }
