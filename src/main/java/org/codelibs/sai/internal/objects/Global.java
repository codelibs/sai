...
import org.codelibs.sai.api.scripting.ClassFilter;
...
import org.codelibs.sai.internal.objects.annotations.Setter;
...
import org.codelibs.sai.internal.runtime.Specialization;
import org.codelibs.sai.internal.runtime.arrays.ArrayData;
import org.codelibs.sai.internal.runtime.linker.Bootstrap;
import org.codelibs.sai.internal.runtime.linker.InvokeByName;
import org.codelibs.sai.internal.runtime.linker.SaiCallSiteDescriptor;
import org.codelibs.sai.internal.runtime.regexp.RegExpResult;
import org.codelibs.sai.internal.scripts.JD;
import org.codelibs.sai.internal.scripts.JO;
import org.codelibs.sai.tools.ShellFunctions;
...
public final class Global extends Scope {
    ...
    /** Sai extension: global.print */
    @Property(attributes = Attribute.NOT_ENUMERABLE)
    public Object print;

    /** Sai extension: global.load */
    @Property(attributes = Attribute.NOT_ENUMERABLE)
    public Object load;

    /** Sai extension: global.loadWithNewGlobal */
    @Property(attributes = Attribute.NOT_ENUMERABLE)
    public Object loadWithNewGlobal;

    /** Sai extension: global.exit */
    @Property(attributes = Attribute.NOT_ENUMERABLE)
    public Object exit;

    /** Sai extension: global.quit */
    @Property(attributes = Attribute.NOT_ENUMERABLE)
    public Object quit;
    ...
    /**
     * Getter for Sai extension: global.JSAdapter
     * @param self self reference
    ...
    /**
     * Setter for Sai extension: global.JSAdapter
     * @param self self reference
    ...
    /** Sai extension: Java access - global.com */
    @Property(attributes = Attribute.NOT_ENUMERABLE)
    public volatile Object com;

    /** Sai extension: Java access - global.edu */
    @Property(attributes = Attribute.NOT_ENUMERABLE)
    public volatile Object edu;

    /** Sai extension: Java access - global.java */
    @Property(attributes = Attribute.NOT_ENUMERABLE)
    public volatile Object java;

    /** Sai extension: Java access - global.javafx */
    @Property(attributes = Attribute.NOT_ENUMERABLE)
    public volatile Object javafx;

    /** Sai extension: Java access - global.javax */
    @Property(attributes = Attribute.NOT_ENUMERABLE)
    public volatile Object javax;

    /** Sai extension: Java access - global.org */
    @Property(attributes = Attribute.NOT_ENUMERABLE)
    public volatile Object org;

    /**
     * Getter for the Sai extension: Java access - global.JavaImporter.
     *
     * @param self self reference
    ...
    /**
     * Setter for the Sai extension: Java access - global.JavaImporter.
     *
     * @param self self reference
    ...
    /**
     * Getter for the Sai extension: global.Java property.
     *
     * @param self self reference
    ...
    /**
     * Setter for the Sai extension: global.Java property.
     *
     * @param self self reference
    ...
    /** Sai extension: current script's file name */
    ...
    /** Sai extension: current script's directory */
    ...
    /** Sai extension: current source line number being executed */
    ...
    private static PropertyMap checkAndGetMap(final Context context) {
        ...
        if (sm != null) {
            sm.checkPermission(new RuntimePermission(Context.SAI_CREATE_GLOBAL));
        }
    ...
    public PropertyDescriptor newAccessorDescriptor(final Object get, final Object set, final boolean configurable, final boolean enumerable) {
        final AccessorPropertyDescriptor desc =
                new AccessorPropertyDescriptor(configurable, enumerable, get == null ? UNDEFINED : get, set == null ? UNDEFINED : set, this);
    ...
    /**
     * Global print implementation - Sai extension
     *
     * @param self    scope
    ...
    /**
     * Global println implementation - Sai extension
     *
     * @param self    scope
     * @param objects arguments to print
     *
    ...
    /**
     * Global load implementation - Sai extension.
     *
     * <p>
    ...
    /**
     * Global loadWithNewGlobal implementation - Sai extension.
     *
    ...
    /**
     * Global exit and quit implementation - Sai extension: perform a {@code System.exit} call from the script
     *
     * @param self  self reference
    ...
    @Override
    public void addBoundProperties(final ScriptObject source, final org.codelibs.sai.internal.runtime.Property[] properties) {
        ...
        if (context.getEnv()._es6) {
            ...
            for (final org.codelibs.sai.internal.runtime.Property property : properties) {
    ...
    public GuardedInvocation findGetMethod(final CallSiteDescriptor desc, final LinkRequest request, final String operator) {
        ...
        final boolean isScope = SaiCallSiteDescriptor.isScope(desc);

        if (lexicalScope != null && isScope && !SaiCallSiteDescriptor.isApplyToCall(desc)) {
    ...
    private void init(final ScriptEngine eng) {
        ...
        this.parseInt =
                ScriptFunction.createBuiltin("parseInt", GlobalFunctions.PARSEINT, new Specialization[] {
                        new Specialization(GlobalFunctions.PARSEINT_Z), new Specialization(GlobalFunctions.PARSEINT_I),
                        new Specialization(GlobalFunctions.PARSEINT_OI), new Specialization(GlobalFunctions.PARSEINT_O) });
        this.parseFloat = ScriptFunction.createBuiltin("parseFloat", GlobalFunctions.PARSEFLOAT);
        this.isNaN =
                ScriptFunction.createBuiltin("isNaN", GlobalFunctions.IS_NAN, new Specialization[] {
                        new Specialization(GlobalFunctions.IS_NAN_I), new Specialization(GlobalFunctions.IS_NAN_J),
        ...
        if (!env._no_java) {
            ...
            // delete saigen-created global properties related to java access
        ...
        if (Context.DEBUG) {
            ...
            if (sm != null) {
                try {
                    sm.checkPermission(new RuntimePermission(Context.SAI_DEBUG_MODE));
                    debugOkay = true;
    ...
    private void initErrorObjects() {
        ...
        // Sai specific accessors on Error.prototype - stack, lineNumber, columnNumber and fileName
    ...
    private void initScripting(final ScriptEnvironment scriptEnv) {
        ...
        // Sai extension: global.echo (scripting-mode-only)
        // alias for "print"
        value = (ScriptObject) get("print");
        addOwnProperty("echo", Attribute.NOT_ENUMERABLE, value);

        // Sai extension: global.$OPTIONS (scripting-mode-only)
        final ScriptObject options = newObject();
        copyOptions(options, scriptEnv);
        addOwnProperty("$OPTIONS", Attribute.NOT_ENUMERABLE, options);

        // Sai extension: global.$ENV (scripting-mode-only)
    ...
    private <T extends ScriptObject> T initConstructor(final String name, final Class<T> clazz) {
        try {
            ...
            final StringBuilder sb = new StringBuilder("org.codelibs.sai.internal.objects.");
    ...
    private List<org.codelibs.sai.internal.runtime.Property> extractBuiltinProperties(final String name, final ScriptObject func) {
        final List<org.codelibs.sai.internal.runtime.Property> list = new ArrayList<>();
        ...
        final org.codelibs.sai.internal.runtime.Property prop = getProperty(name);
        if (prop != null) {
            list.add(prop);
        }
    ...
    private void tagBuiltinProperties(final String name, final ScriptObject func) {
        ...
        for (final org.codelibs.sai.internal.runtime.Property prop : extractBuiltinProperties(name, func)) {
    ...
    private void initFunctionAndObject() {
        ...
        org.codelibs.sai.internal.runtime.Property[] properties = getFunctionPrototype().getMap().getProperties();
        for (final org.codelibs.sai.internal.runtime.Property property : properties) {
        ...
        for (final org.codelibs.sai.internal.runtime.Property property : builtinObject.getMap().getProperties()) {
            final Object key = property.getKey();
    ...
    private static class LexicalScope extends ScriptObject {
        ...
        @Override
        protected PropertyMap addBoundProperty(final PropertyMap propMap, final ScriptObject source,
                final org.codelibs.sai.internal.runtime.Property property, final boolean extensible) {
