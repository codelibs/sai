...
import static org.codelibs.sai.org.objectweb.asm.Opcodes.DALOAD;
import static org.codelibs.sai.org.objectweb.asm.Opcodes.DASTORE;
...
import static org.codelibs.sai.org.objectweb.asm.Opcodes.DUP2_X1;
import static org.codelibs.sai.org.objectweb.asm.Opcodes.DUP2_X2;
import static org.codelibs.sai.org.objectweb.asm.Opcodes.DUP_X1;
import static org.codelibs.sai.org.objectweb.asm.Opcodes.DUP_X2;
import static org.codelibs.sai.org.objectweb.asm.Opcodes.H_INVOKESTATIC;
import static org.codelibs.sai.org.objectweb.asm.Opcodes.IALOAD;
import static org.codelibs.sai.org.objectweb.asm.Opcodes.IASTORE;
import static org.codelibs.sai.org.objectweb.asm.Opcodes.INVOKESTATIC;
import static org.codelibs.sai.org.objectweb.asm.Opcodes.LALOAD;
import static org.codelibs.sai.org.objectweb.asm.Opcodes.LASTORE;
import static org.codelibs.sai.org.objectweb.asm.Opcodes.NEWARRAY;
import static org.codelibs.sai.org.objectweb.asm.Opcodes.POP;
import static org.codelibs.sai.org.objectweb.asm.Opcodes.POP2;
import static org.codelibs.sai.org.objectweb.asm.Opcodes.SWAP;
import static org.codelibs.sai.org.objectweb.asm.Opcodes.T_DOUBLE;
import static org.codelibs.sai.org.objectweb.asm.Opcodes.T_INT;
import static org.codelibs.sai.org.objectweb.asm.Opcodes.T_LONG;
...
public abstract class Type implements Comparable<Type>, BytecodeOps, Serializable {
     ...
     */
    private static final Map<Class<?>, org.codelibs.sai.org.objectweb.asm.Type> INTERNAL_TYPE_CACHE = Collections
            .synchronizedMap(new WeakHashMap<Class<?>, org.codelibs.sai.org.objectweb.asm.Type>());

    /** Internal ASM type for this Type - computed once at construction */
    private transient final org.codelibs.sai.org.objectweb.asm.Type internalType;
    ...
    Type(final String name, final Class<?> clazz, final int weight, final int slots) {
        this.name = name;
        this.clazz = clazz;
        this.descriptor = org.codelibs.sai.org.objectweb.asm.Type.getDescriptor(clazz);
        this.weight = weight;
     ...
     * Note that while we allow all JVM internal types, Sai doesn't necessarily use them all - currently we don't
    ...
    public static String getMethodDescriptor(final Type returnType, final Type... types) {
        final org.codelibs.sai.org.objectweb.asm.Type[] itypes = new org.codelibs.sai.org.objectweb.asm.Type[types.length];
        for (int i = 0; i < types.length; i++) {
            itypes[i] = types[i].getInternalType();
        }
        return org.codelibs.sai.org.objectweb.asm.Type.getMethodDescriptor(returnType.getInternalType(), itypes);
    }
    ...
    public static String getMethodDescriptor(final Class<?> returnType, final Class<?>... types) {
        ...
        return org.codelibs.sai.org.objectweb.asm.Type.getMethodDescriptor(getInternalType(returnType), itypes);
    }
    ...
    static Type typeFor(final org.codelibs.sai.org.objectweb.asm.Type itype) {
        switch (itype.getSort()) {
        case org.codelibs.sai.org.objectweb.asm.Type.BOOLEAN:
            return BOOLEAN;
        case org.codelibs.sai.org.objectweb.asm.Type.INT:
            return INT;
        case org.codelibs.sai.org.objectweb.asm.Type.LONG:
            return LONG;
        case org.codelibs.sai.org.objectweb.asm.Type.DOUBLE:
            return NUMBER;
        case org.codelibs.sai.org.objectweb.asm.Type.OBJECT:
        ...
        case org.codelibs.sai.org.objectweb.asm.Type.VOID:
            return null;
        case org.codelibs.sai.org.objectweb.asm.Type.ARRAY:
    ...
    public static Type getMethodReturnType(final String methodDescriptor) {
        return Type.typeFor(org.codelibs.sai.org.objectweb.asm.Type.getReturnType(methodDescriptor));
    }
    ...
    public static Type[] getMethodArguments(final String methodDescriptor) {
        final org.codelibs.sai.org.objectweb.asm.Type itypes[] = org.codelibs.sai.org.objectweb.asm.Type.getArgumentTypes(methodDescriptor);
    ...
    static org.codelibs.sai.org.objectweb.asm.Type getInternalType(final String className) {
        return org.codelibs.sai.org.objectweb.asm.Type.getType(className);
    }

    private org.codelibs.sai.org.objectweb.asm.Type getInternalType() {
        return internalType;
    }

    private static org.codelibs.sai.org.objectweb.asm.Type lookupInternalType(final Class<?> type) {
        final Map<Class<?>, org.codelibs.sai.org.objectweb.asm.Type> c = INTERNAL_TYPE_CACHE;
        org.codelibs.sai.org.objectweb.asm.Type itype = c.get(type);
        if (itype != null) {
            return itype;
        }
        itype = org.codelibs.sai.org.objectweb.asm.Type.getType(type);
        c.put(type, itype);
        return itype;
    }

    private static org.codelibs.sai.org.objectweb.asm.Type getInternalType(final Class<?> type) {
    ...
    public String getInternalName() {
        return org.codelibs.sai.org.objectweb.asm.Type.getInternalName(getTypeClass());
    }
    ...
    public static String getInternalName(final Class<?> clazz) {
        return org.codelibs.sai.org.objectweb.asm.Type.getInternalName(clazz);
    }
     ...
     * (either a {@code java.lang.String} or {@code org.codelibs.sai.internal.runtime.ConsString}.
     */
