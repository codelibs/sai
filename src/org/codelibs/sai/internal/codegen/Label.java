 ...
 *
 * see -Dsai.codegen.debug, --log=codegen
 */
public final class Label implements Serializable {
    ...
    static final class Stack implements Cloneable {
        ...
        private int getFirstDeadLocal(final List<Type> types) {
            int i = types.size();
            for (final ListIterator<Type> it = types.listIterator(i); it.hasPrevious() && it.previous() == Type.UNKNOWN; --i) {
                // no body
            }
        ...
        public String toString() {
            return "stack=" + Arrays.toString(Arrays.copyOf(data, sp)) + ", symbolBoundaries=" + String.valueOf(symbolBoundary)
                    + ", firstTemp=" + firstTemp + ", localTypes=" + String.valueOf(localVariableTypes);
        }
    }
    ...
    private transient org.codelibs.sai.org.objectweb.asm.Label label;
    ...
    org.codelibs.sai.org.objectweb.asm.Label getLabel() {
        if (this.label == null) {
            this.label = new org.codelibs.sai.org.objectweb.asm.Label();
        }
        return label;
    }
