...
/**
 * This class is the implementation of the Sai-specific global object named {@code JSAdapter}. It can be
...
public final class NativeJSAdapter extends ScriptObject {
    ...
    private static final MethodHandle IS_JSADAPTOR = findOwnMH("isJSAdaptor", boolean.class, Object.class, Object.class,
            MethodHandle.class, Object.class, ScriptFunction.class);
    ...
    public double getDouble(final Object key, final int programPoint) {
        return (overrides && super.hasOwnProperty(key)) ? super.getDouble(key, programPoint)
                : callAdapteeDouble(programPoint, __get__, key);
    }
    ...
    public static NativeJSAdapter construct(final boolean isNew, final Object self, final Object... args) {
        ...
        return new NativeJSAdapter(overrides, (ScriptObject) adaptee, (ScriptObject) proto, $saigenmap$);
    }
        ...
        case "getMethod":
            ...
            if (find != null) {
                ...
                if (value instanceof ScriptFunction) {
                    ...
                    return new GuardedInvocation(MH.dropArguments(MH.constant(Object.class, func.createBound(this, new Object[] { name })),
                            0, Object.class), testJSAdaptor(adaptee, null, null, null), adaptee.getProtoSwitchPoints(__call__,
                            find.getOwner()), null);
                }
            }
    ...
    private GuardedInvocation findHook(final CallSiteDescriptor desc, final String hook, final boolean useName) {
        ...
        if (findData != null) {
            ...
            if (value instanceof ScriptFunction) {
                ...
                final MethodHandle methodHandle = getCallMethodHandle(findData, type, useName ? name : null);
                if (methodHandle != null) {
                    return new GuardedInvocation(methodHandle, testJSAdaptor(adaptee,
                            findData.getGetter(Object.class, INVALID_PROGRAM_POINT, null), findData.getOwner(), func),
        ...
        default:
            final MethodHandle methodHandle =
                    hook.equals(__put__) ? MH.asType(Lookup.EMPTY_SETTER, type) : Lookup.emptyGetter(type.returnType());
            return new GuardedInvocation(methodHandle, testJSAdaptor(adaptee, null, null, null), adaptee.getProtoSwitchPoints(hook, null),
                    null);
        }
    }
    ...
    private static boolean isJSAdaptor(final Object self, final Object adaptee, final MethodHandle getter, final Object where,
