...
package org.codelibs.sai.internal.lookup;
...
public final class MethodHandleFactory {
    ...
    private static final boolean PRINT_STACKTRACE = Options.getBooleanProperty("sai.methodhandles.debug.stacktrace");
    ...
    private static final MethodHandle TRACE = FUNC.findStatic(LOOKUP, MethodHandleFactory.class, "traceArgs",
            MethodType.methodType(void.class, DebugLogger.class, String.class, int.class, Object[].class));
    private static final MethodHandle TRACE_RETURN = FUNC.findStatic(LOOKUP, MethodHandleFactory.class, "traceReturn",
            MethodType.methodType(Object.class, DebugLogger.class, Object.class));
    private static final MethodHandle TRACE_RETURN_VOID = FUNC.findStatic(LOOKUP, MethodHandleFactory.class, "traceReturnVoid",
            MethodType.methodType(void.class, DebugLogger.class));
     ...
     * @return  traced method handle
     */
    public static MethodHandle addDebugPrintout(final MethodHandle mh, final int paramStart, final boolean printReturnValue,
            final Object tag) {
     ...
     * @return  traced method handle
     */
    public static MethodHandle addDebugPrintout(final DebugLogger logger, final Level level, final MethodHandle mh, final int paramStart,
            final boolean printReturnValue, final Object tag) {
        ...
        trace =
                MethodHandles.foldArguments(mh,
                        trace.asCollector(Object[].class, type.parameterCount()).asType(type.changeReturnType(void.class)));
        ...
        if (printReturnValue) {
            if (retType != void.class) {
                ...
                trace =
                        MethodHandles.filterReturnValue(trace,
     ...
     * Sai made possible to instrument.
     *
     * All Sai classes should use the MethodHandleFactory for their method handle operations
     */
    ...
    private static class StandardMethodHandleFunctionality implements MethodHandleFunctionality, Loggable {
        ...
        @Override
        public MethodHandle staticGetter(final MethodHandles.Lookup explicitLookup, final Class<?> clazz, final String name,
                final Class<?> type) {
            try {
        ...
        @Override
        public MethodHandle staticSetter(final MethodHandles.Lookup explicitLookup, final Class<?> clazz, final String name,
                final Class<?> type) {
            try {
        ...
        @Override
        public MethodHandle findStatic(final MethodHandles.Lookup explicitLookup, final Class<?> clazz, final String name,
        ...
        @Override
        public MethodHandle findSpecial(final MethodHandles.Lookup explicitLookup, final Class<?> clazz, final String name,
                final MethodType type, final Class<?> thisClass) {
            try {
        ...
        @Override
        public MethodHandle findVirtual(final MethodHandles.Lookup explicitLookup, final Class<?> clazz, final String name,
                final MethodType type) {
            try {
