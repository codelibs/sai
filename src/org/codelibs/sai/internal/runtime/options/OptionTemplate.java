...
public final class OptionTemplate implements Comparable<OptionTemplate> {
    /** Resource, e.g. "sai" for this option */
    ...
    /**
     * Get the resource name used to prefix this option set, e.g. "sai"
     *
    ...
    public String toString() {
        ...
        if (params != null) {
            ...
            sb.append('\t');
            sb.append('\t');
            sb.append(Options.getMsg("sai.options.param")).append(": ");
            sb.append(params);
            sb.append("   ");
            final Object def = this.getDefaultValue();
            if (def != null) {
                sb.append(Options.getMsg("sai.options.default")).append(": ");
