...
package org.codelibs.sai.internal.runtime.options;
...
import org.codelibs.sai.internal.runtime.QuotedStringTokenizer;
...
public final class Options {
    ...
    private static final String SAI_ARGS_PREPEND_PROPERTY = "sai.args.prepend";

    /** System property that can be used to append options to the explicitly specified command line. */
    private static final String SAI_ARGS_PROPERTY = "sai.args";
     ...
     *
     * @param resource resource prefix for options e.g. "sai"
     */
    ...
    /**
     * Get the resource for this Options set, e.g. "sai"
     * @return the resource
     */
    ...
    private static void checkPropertyName(final String name) {
        if (!Objects.requireNonNull(name).startsWith("sai.")) {
    ...
    public void displayHelp(final IllegalArgumentException e) {
        ...
        if (e != null && e.getMessage() != null) {
            err.println(getMsg("option.error.invalid.option", e.getMessage(), helpOptionTemplate.getShortName(),
    ...
    public void process(final String[] args) {
        ...
        addSystemProperties(SAI_ARGS_PREPEND_PROPERTY, argList);
        processArgList(argList);
        assert argList.isEmpty();
        Collections.addAll(argList, args);
        processArgList(argList);
        assert argList.isEmpty();
        addSystemProperties(SAI_ARGS_PROPERTY, argList);
        processArgList(argList);
        assert argList.isEmpty();
    }
     ...
     * @param shortKey the short (that is without the e.g. "sai.option." part) key
     ...
     */
    private static final String MESSAGES_RESOURCE = "org.codelibs.sai.internal.runtime.resources.Options";
