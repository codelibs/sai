...
import static org.codelibs.sai.internal.codegen.CompilerConstants.virtualField;
 ...
 * ReferenceError thrown from Sai engine runtime).
 */
@SuppressWarnings("serial")
public final class ECMAException extends SaiException {
    /**
     * Method handle pointing to the constructor {@link ECMAException#create(Object, String, int, int)},
     */
    public static final Call CREATE = staticCallNoLookup(ECMAException.class, "create", ECMAException.class, Object.class, String.class,
            int.class, int.class);
    ...
    private static final String EXCEPTION_PROPERTY = "saiException";
    ...
    public static Object getLineNumber(final ScriptObject errObj) {
        ...
        if (e instanceof SaiException) {
            return ((SaiException) e).getLineNumber();
    ...
    public static Object getColumnNumber(final ScriptObject errObj) {
        final Object e = getException(errObj);
        if (e instanceof SaiException) {
            return ((SaiException) e).getColumnNumber();
        } else if (e instanceof ScriptException) {
    ...
    public static Object getFileName(final ScriptObject errObj) {
        final Object e = getException(errObj);
        if (e instanceof SaiException) {
            return ((SaiException) e).getFileName();
        } else if (e instanceof ScriptException) {
    ...
    private void setExceptionToThrown() {
        /*
         * Sai extension: errorObject.saiException
         * Expose this exception via "saiException" property of on the
