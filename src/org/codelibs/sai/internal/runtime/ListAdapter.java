...
public class ListAdapter extends AbstractList<Object> implements RandomAccess, Deque<Object> {
    ...
    private static final Callable<MethodHandle> ADD_INVOKER_CREATOR =
            invokerCreator(void.class, Object.class, JSObject.class, Object.class);
    ...
    private static final Callable<MethodHandle> SPLICE_ADD_INVOKER_CREATOR = invokerCreator(void.class, Object.class, JSObject.class,
    ...
    private static final Callable<MethodHandle> SPLICE_REMOVE_INVOKER_CREATOR = invokerCreator(void.class, Object.class, JSObject.class,
            int.class, int.class);
