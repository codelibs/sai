 ...
 * numbers). This class is only public so it can be accessed by classes in the {@code org.codelibs.sai.internal.objects}
 * package.
 */
public final class PrimitiveLookup {
    ...
    public static GuardedInvocation lookupPrimitive(final LinkRequest request, final Class<?> receiverClass,
            final ScriptObject wrappedReceiver, final MethodHandle wrapFilter, final MethodHandle protoFilter) {
    ...
    public static GuardedInvocation lookupPrimitive(final LinkRequest request, final MethodHandle guard,
        ...
        case "getMethod":
            ...
            if (name != null) {
                if (find == null) {
                    // Give up early, give chance to BeanLinker and SaiBottomLinker to deal with it.
                    return null;
                }
                ...
                if (find.isInherited() && !(find.getProperty() instanceof UserAccessorProperty)) {
                    ...
                    if (link != null) {
                        ...
                        final MethodHandle adaptedInvocation =
                                MH.asType(invocation, invocation.type().changeParameterType(0, Object.class));
                        ...
                        return new GuardedInvocation(method, SaiGuards.combineGuards(guard, protoGuard));
                    }
                }
            }
            break;
        case "setProp":
        case "setElem":
            return getPrimitiveSetter(name, guard, wrapFilter, SaiCallSiteDescriptor.isStrict(desc));
        default:
            break;
        }
    ...
    private static void primitiveSetter(final ScriptObject wrappedSelf, final Object self, final Object key, final boolean strict,
            final Object value) {
