...
public final class JavaAdapterServices {
    ...
    private static MethodHandle createNoPermissionsInvoker() {
        ...
        final InstructionAdapter mv =
                new InstructionAdapter(cw.visitMethod(ACC_PUBLIC | ACC_STATIC, "invoke",
    ...
    /**
     * Invoked when returning Object from an adapted method to filter out internal Sai objects that must not be seen
    ...
    public static Object exportReturnValue(final Object obj) {
        return SaiBeansLinker.exportArgument(obj, true);
    }
