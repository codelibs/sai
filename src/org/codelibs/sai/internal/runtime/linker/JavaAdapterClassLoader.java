...
import org.codelibs.sai.internal.codegen.DumpBytecode;
...
final class JavaAdapterClassLoader {
    ...
    // of Sai itself. Also note that the creation and loading of the global setter is deferred until it is
        ...
        return new SecureClassLoader(parentLoader) {
            ...
            public Class<?> loadClass(final String name, final boolean resolve) throws ClassNotFoundException {
                try {
                    ...
                    // SecurityException for sai's classes!. For adapter's to work, we
            ...
            protected Class<?> findClass(final String name) throws ClassNotFoundException {
                if (name.equals(className)) {
                    ...
                    DumpBytecode.dumpBytecode(ctx.getEnv(), ctx.getLogger(org.codelibs.sai.internal.codegen.Compiler.class), classBytes,
                            name);
