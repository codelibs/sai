...
public final class ScriptingFunctions {
    ...
    /** Handle to implementation of {@link ScriptingFunctions#readLine} - Sai extension */
    public static final MethodHandle READLINE = findOwnMH("readLine", Object.class, Object.class, Object.class);

    /** Handle to implementation of {@link ScriptingFunctions#readFully} - Sai extension */
    public static final MethodHandle READFULLY = findOwnMH("readFully", Object.class, Object.class, Object.class);

    /** Handle to implementation of {@link ScriptingFunctions#exec} - Sai extension */
    ...
    /**
     * Sai extension: global.readLine (scripting-mode-only)
    ...
    /**
     * Sai extension: Read the entire contents of a text file and return as String.
     *
     * @param self self reference
    ...
    /**
     * Sai extension: exec a string in a separate process.
     *
     * @param self   self reference
    ...
    public static Object exec(final Object self, final Object... args) throws IOException, InterruptedException {
        ...
        final Object[] additionalArgs = argv.length == 1 && argv[0] instanceof NativeArray ? ((NativeArray) argv[0]).asObjectArray() : argv;
