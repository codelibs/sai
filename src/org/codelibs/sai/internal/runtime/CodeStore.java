...
public abstract class CodeStore implements Loggable {
     ...
     */
    public final static String SAI_PROVIDE_CODE_STORE = "sai.provideCodeStore";
    ...
    public static CodeStore newCodeStore(final Context context) {
        ...
        try {
            ...
            if (sm != null) {
                sm.checkPermission(new RuntimePermission(SAI_PROVIDE_CODE_STORE));
            }
     ...
     */
    public StoredScript store(final String functionKey, final Source source, final String mainClassName,
     ...
     */
    public abstract StoredScript store(final String functionKey, final Source source, final StoredScript script);
     ...
     */
    public StoredScript storedScriptFor(final Source source, final String mainClassName, final Map<String, byte[]> classBytes,
    ...
    public static class DirectoryCodeStore extends CodeStore {
        ...
        public DirectoryCodeStore(final Context context) throws IOException {
            this(context, Options.getStringProperty("sai.persistent.code.cache", "sai_code_cache"), false, DEFAULT_MIN_SIZE);
        }
