...
public final class OptimisticReturnFilters {
    ...
    static {
        ...
        ENSURE_INT =
                new MethodHandle[] { null, INT_DOUBLE, findOwnMH("ensureInt", int.class, Object.class, int.class),
                        findOwnMH("ensureInt", int.class, int.class), findOwnMH("ensureInt", int.class, boolean.class, int.class),
                        findOwnMH("ensureInt", int.class, char.class, int.class), findOwnMH("ensureInt", int.class, long.class, int.class),
        ...
        ENSURE_NUMBER =
                new MethodHandle[] { null, null, findOwnMH("ensureNumber", double.class, Object.class, int.class),
                        ...
                        findOwnMH("ensureNumber", double.class, long.class, int.class), null };
    }
    ...
    public static GuardedInvocation filterOptimisticReturnValue(final GuardedInvocation inv, final CallSiteDescriptor desc) {
        ...
        return inv.replaceMethods(
                filterOptimisticReturnValue(inv.getInvocation(), desc.getMethodType().returnType(),
                        SaiCallSiteDescriptor.getProgramPoint(desc)), inv.getGuard());
    }
