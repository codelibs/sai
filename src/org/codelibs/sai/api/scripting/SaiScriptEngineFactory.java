...
/**
 * JSR-223 compliant script engine factory for Sai. The engine answers for:
 * <ul>
 * <li>names {@code "sai"}, {@code "Sai"}, {@code "js"}, {@code "JS"}, {@code "JavaScript"},
...
public final class SaiScriptEngineFactory implements ScriptEngineFactory {
    ...
    // default options passed to Sai script engine
    private static final String[] DEFAULT_OPTIONS = new String[] { "-doe" };

    @Override
    public ScriptEngine getScriptEngine() {
        try {
            return new SaiScriptEngine(this, DEFAULT_OPTIONS, getAppClassLoader(), null);
     ...
     *         denies {@code RuntimePermission("sai.setConfig")}
     */
    ...
    private ScriptEngine newEngine(final String[] args, final ClassLoader appLoader, final ClassFilter classFilter) {
        ...
        try {
            return new SaiScriptEngine(this, args, appLoader, classFilter);
        } catch (final RuntimeException e) {
            if (Context.DEBUG) {
                e.printStackTrace();
            }
    ...
    private static void checkConfigPermission() {
        ...
        if (sm != null) {
            sm.checkPermission(new RuntimePermission(Context.SAI_SET_CONFIG));
        }
    }
    ...
    static {
        names = immutableList("sai", "Sai", "js", "JS", "JavaScript", "javascript", "ECMAScript", "ecmascript");
    ...
    private static ClassLoader getAppClassLoader() {
        ...
        return (ccl == null) ? SaiScriptEngineFactory.class.getClassLoader() : ccl;
    }
}
